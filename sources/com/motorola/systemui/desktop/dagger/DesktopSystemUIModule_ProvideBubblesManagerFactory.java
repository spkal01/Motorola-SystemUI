...
public final class DesktopSystemUIModule_ProvideBubblesManagerFactory implements Factory<Optional<BubblesManager>> {
    ...
    public static DesktopSystemUIModule_ProvideBubblesManagerFactory create(Provider<Context> provider, Provider<Optional<Bubbles>> provider2, Provider<NotificationShadeWindowController> provider3, Provider<StatusBarStateController> provider4, Provider<ShadeController> provider5, Provider<ConfigurationController> provider6, Provider<IStatusBarService> provider7, Provider<INotificationManager> provider8, Provider<NotificationInterruptStateProvider> provider9, Provider<ZenModeController> provider10, Provider<NotificationLockscreenUserManager> provider11, Provider<NotificationGroupManagerLegacy> provider12, Provider<NotificationEntryManager> provider13, Provider<NotifPipeline> provider14, Provider<SysUiState> provider15, Provider<FeatureFlags> provider16, Provider<DumpManager> provider17, Provider<Executor> provider18) {
        return new DesktopSystemUIModule_ProvideBubblesManagerFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13, provider14, provider15, provider16, provider17, provider18);
    }
