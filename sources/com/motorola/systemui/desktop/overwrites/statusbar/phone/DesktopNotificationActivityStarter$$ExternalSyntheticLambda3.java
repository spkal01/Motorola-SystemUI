...
public final /* synthetic */ class DesktopNotificationActivityStarter$$ExternalSyntheticLambda3 implements Runnable {
    ...
    public /* synthetic */ DesktopNotificationActivityStarter$$ExternalSyntheticLambda3(DesktopNotificationActivityStarter desktopNotificationActivityStarter, NotificationEntry notificationEntry, ExpandableNotificationRow expandableNotificationRow, RemoteInputController remoteInputController, PendingIntent pendingIntent, boolean z, boolean z2) {
    ...
    public final void run() {
        this.f$0.lambda$handleNotificationClickAfterKeyguardDismissed$1(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
