...
public class SignalDrawable extends DrawableWrapper {
    ...
    private int mDoubleSignalIntrinsicHeight;
    private int mDoubleSignalIntrinsicWidth;
    private final Paint mForegroundPaint = new Paint(1);
    private final Path mForegroundPath;
    /* access modifiers changed from: private */
    public final Handler mHandler;
    private final int mIntrinsicSize;
    private boolean mIsDoubleSignal;
    ...
    public SignalDrawable(Context context) {
        super(context.getDrawable(17303717));
        ...
        path.set(PathParser.createPathFromPathData(context.getString(17040025)));
        updateScaledAttributionPath();
        this.mCutoutWidthFraction = context.getResources().getFloat(17105117);
        this.mCutoutHeightFraction = context.getResources().getFloat(17105116);
        ...
        this.mIntrinsicSize = resources.getDimensionPixelSize(R$dimen.signal_icon_size);
        this.mDoubleSignalIntrinsicWidth = resources.getDimensionPixelSize(R$dimen.zz_moto_double_signal_width);
        this.mDoubleSignalIntrinsicHeight = resources.getDimensionPixelSize(R$dimen.zz_moto_double_signal_height);
    ...
    public int getIntrinsicWidth() {
        return this.mIsDoubleSignal ? this.mDoubleSignalIntrinsicWidth : this.mIntrinsicSize;
    }

    public int getIntrinsicHeight() {
        return this.mIsDoubleSignal ? this.mDoubleSignalIntrinsicHeight : this.mIntrinsicSize;
    }

    public void setDoubleSignalFlag(boolean z) {
        this.mIsDoubleSignal = z;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        float round = (float) Math.round(this.mIsDoubleSignal ? 0.083333336f * height : 0.083333336f * width);
        if (isInState(3)) {
