...
public class BatteryMeterDrawableBase extends Drawable {
    ...
    private int mBatteryPercentCloor = -1;
    private int mBatteryPercentDarkColor;
    private int mBatteryPercentLightColor;
    ...
    public BatteryMeterDrawableBase(Context context, int i) {
        ...
        this.mBatteryPercentDarkColor = context.getColor(R$color.dark_battery_percent_color);
        this.mBatteryPercentLightColor = context.getColor(R$color.light_battery_percent_color);
    }
    ...
    private int getBatteryPercentColor() {
        return this.mBatteryPercentCloor;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (i != -1) {
            ...
            if (this.mCharging || this.mPowerSaveEnabled || i <= this.mCriticalLevel || !this.mShowPercent) {
                ...
                this.mTextPaint.setColor(getBatteryPercentColor());
                ...
                if (!z) {
                    ...
                    canvas2.drawPath(this.mTextPath, this.mTextPaint);
                }
            }
