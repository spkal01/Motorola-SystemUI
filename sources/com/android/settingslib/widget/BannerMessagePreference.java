...
public class BannerMessagePreference extends Preference {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (IS_AT_LEAST_S) {
            ...
            int unused3 = this.mPositiveButtonInfo.mColor = color;
            int unused4 = this.mNegativeButtonInfo.mColor = color;
            ImageButton unused5 = this.mDismissButtonInfo.mButton = (ImageButton) preferenceViewHolder.findViewById(R$id.banner_dismiss_btn);
