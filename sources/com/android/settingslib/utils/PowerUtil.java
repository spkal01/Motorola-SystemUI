...
public class PowerUtil {
    ...
    private static String getShutdownImminentString(Context context, String str) {
        ...
        return context.getString(R$string.power_remaining_duration_shutdown_imminent, new Object[]{str});
    }

    private static String getUnderFifteenString(Context context, CharSequence charSequence, String str) {
        if (TextUtils.isEmpty(str)) {
            return context.getString(R$string.power_remaining_less_than_duration_only, new Object[]{charSequence});
        }
        return context.getString(R$string.power_remaining_less_than_duration, new Object[]{charSequence, str});
    }
    ...
    private static String getMoreThanTwoDaysString(Context context, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            return context.getString(R$string.power_remaining_only_more_than_subtext, new Object[]{instance.formatMeasures(new Measure[]{measure})});
        }
        return context.getString(R$string.power_remaining_more_than_subtext, new Object[]{instance.formatMeasures(new Measure[]{measure}), str});
    }
