...
public class Utils {
    ...
    static final int[] WIFI_PIE = {17303763, 17303764, 17303765, 17303766, 17303767};
    ...
    public static boolean isDeviceProvisioningPackage(Resources resources, String str) {
        String string = resources.getString(17039934);
    ...
    public static int getCombinedServiceState(ServiceState serviceState) {
        ...
        if ((state == 1 || state == 2) && dataRegistrationState == 0 && isInWwan(serviceState)) {
            return 0;
        }
        return state;
    }
    ...
    private static boolean isInWwan(ServiceState serviceState) {
