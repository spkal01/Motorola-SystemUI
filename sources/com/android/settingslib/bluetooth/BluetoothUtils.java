    ...
    public static Pair<Drawable, String> getBtClassDrawableWithDescription(Context context, CachedBluetoothDevice cachedBluetoothDevice) {
        ...
        if (btClass != null) {
            ...
            if (majorDeviceClass == 256) {
                return new Pair<>(getBluetoothDrawable(context, 17303204), context.getString(R$string.bluetooth_talkback_computer));
            }
            if (majorDeviceClass == 512) {
                return new Pair<>(getBluetoothDrawable(context, 17303683), context.getString(R$string.bluetooth_talkback_phone));
            }
            ...
            if (majorDeviceClass == 1536) {
                return new Pair<>(getBluetoothDrawable(context, 17303715), context.getString(R$string.bluetooth_talkback_imaging));
            }
        ...
        if (btClass != null) {
            if (btClass.doesClassMatch(0)) {
                return new Pair<>(getBluetoothDrawable(context, 17303202), context.getString(R$string.bluetooth_talkback_headset));
            }
            if (btClass.doesClassMatch(1)) {
                return new Pair<>(getBluetoothDrawable(context, 17303201), context.getString(R$string.bluetooth_talkback_headphone));
            }
        }
        return new Pair<>(getBluetoothDrawable(context, 17303713).mutate(), context.getString(R$string.bluetooth_talkback_bluetooth));
    }
