...
public class WalletActivity extends LifecycleActivity implements QuickAccessWalletClient.WalletServiceEventListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        walletView.setShowWalletAppOnClickListener(new WalletActivity$$ExternalSyntheticLambda1(this));
        walletView.setDeviceLockedActionOnClickListener(new WalletActivity$$ExternalSyntheticLambda0(this));
    }
    ...
    public /* synthetic */ void lambda$onCreate$1(View view) {
        if (this.mWalletClient.createWalletIntent() == null) {
            ...
            this.mKeyguardDismissUtil.executeWhenUnlocked(new WalletActivity$$ExternalSyntheticLambda2(this), false, true);
        }
    }
    ...
    public void onResume() {
        ...
        this.mKeyguardViewManager.requestFp(true, Utils.getColorAttrDefaultColor(this, 17956901));
