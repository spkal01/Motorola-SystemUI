...
public final class CircularCornerPathRenderer extends CornerPathRenderer {
    ...
    static /* synthetic */ class C08441 {
        ...
        static final /* synthetic */ int[] f75x853e7b3e;
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f75x853e7b3e = r0
                com.android.systemui.assist.ui.CornerPathRenderer$Corner r1 = com.android.systemui.assist.p003ui.CornerPathRenderer.Corner.BOTTOM_LEFT     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f75x853e7b3e     // Catch:{ NoSuchFieldError -> 0x001d }
                com.android.systemui.assist.ui.CornerPathRenderer$Corner r1 = com.android.systemui.assist.p003ui.CornerPathRenderer.Corner.BOTTOM_RIGHT     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = f75x853e7b3e     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.android.systemui.assist.ui.CornerPathRenderer$Corner r1 = com.android.systemui.assist.p003ui.CornerPathRenderer.Corner.TOP_RIGHT     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = f75x853e7b3e     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.android.systemui.assist.ui.CornerPathRenderer$Corner r1 = com.android.systemui.assist.p003ui.CornerPathRenderer.Corner.TOP_LEFT     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.assist.p003ui.CircularCornerPathRenderer.C08441.<clinit>():void");
        }
    }

    public Path getCornerPath(CornerPathRenderer.Corner corner) {
        this.mPath.reset();
        int i = C08441.f75x853e7b3e[corner.ordinal()];
        if (i == 1) {
