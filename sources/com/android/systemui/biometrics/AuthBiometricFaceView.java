...
public class AuthBiometricFaceView extends AuthBiometricView {
    ...
    protected static class IconController extends Animatable2.AnimationCallback {
        ...
        protected IconController(Context context, ImageView imageView, TextView textView) {
    ...
    @VisibleForTesting
    AuthBiometricFaceView(Context context, AttributeSet attributeSet, AuthBiometricView.Injector injector) {
