...
public class AuthBiometricFaceToFingerprintView extends AuthBiometricFaceView {
    ...
    public void onFinishInflate() {
        ...
        this.mUdfpsIconController = new UdfpsIconController(this.mContext, this.mIconView, this.mIndicatorView);
    }
    ...
    private String checkErrorForFallback(String str) {
        ...
        return this.mContext.getString(R$string.fingerprint_dialog_use_fingerprint_instead);
    }
