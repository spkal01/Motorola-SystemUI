...
public class SidefpsController {
    ...
    public SidefpsController(Context context, LayoutInflater layoutInflater, FingerprintManager fingerprintManager, WindowManager windowManager, DelayableExecutor delayableExecutor, DisplayManager displayManager, Handler handler) {
        C08621 r1 = new ISidefpsController.Stub() {
            public void show() {
            ...
            public /* synthetic */ void lambda$show$0() {
                ...
                boolean unused = SidefpsController.this.mIsVisible = true;
            }
            ...
            public /* synthetic */ void lambda$hide$1() {
                ...
                boolean unused = SidefpsController.this.mIsVisible = false;
            }
        };
        ...
        this.mOrientationListener = new BiometricOrientationEventListener(context, new SidefpsController$$ExternalSyntheticLambda0(this), displayManager, handler);
