...
public class PeopleSpaceActivity extends Activity {
    ...
    private void buildActivity() {
        ...
        ((GradientDrawable) ((LinearLayout) findViewById(16908288)).getBackground()).setColor(this.mContext.getTheme().obtainStyledAttributes(new int[]{17956910}).getColor(0, -1));
    }
