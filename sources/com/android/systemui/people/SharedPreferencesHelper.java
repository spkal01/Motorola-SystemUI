...
public class SharedPreferencesHelper {
    ...
    public static PeopleTileKey getPeopleTileKey(SharedPreferences sharedPreferences) {
        return new PeopleTileKey(sharedPreferences.getString("shortcut_id", (String) null), sharedPreferences.getInt("user_id", -1), sharedPreferences.getString("package_name", (String) null));
    }
}
