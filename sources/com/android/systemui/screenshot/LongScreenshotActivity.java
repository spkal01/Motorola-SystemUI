...
public class LongScreenshotActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        requireViewById(R$id.cancel).setOnClickListener(new LongScreenshotActivity$$ExternalSyntheticLambda1(this));
        this.mSave.setOnClickListener(new LongScreenshotActivity$$ExternalSyntheticLambda0(this));
        this.mEdit.setOnClickListener(new LongScreenshotActivity$$ExternalSyntheticLambda0(this));
        this.mShare.setOnClickListener(new LongScreenshotActivity$$ExternalSyntheticLambda0(this));
    ...
    public void onStart() {
        ...
        if (this.mPreview.getDrawable() == null) {
            if (this.mCacheLoadFuture != null) {
                ...
                listenableFuture.addListener(new LongScreenshotActivity$$ExternalSyntheticLambda5(this, listenableFuture), this.mUiExecutor);
    ...
    public void lambda$startExport$4(PendingAction pendingAction, ListenableFuture<ImageExporter.Result> listenableFuture) {
        ...
        try {
            ...
            int i = C13082.f122x6ba3e28f[pendingAction.ordinal()];
            if (i == 1) {
                doEdit(result.uri);
            } else if (i == 2) {
                doShare(result.uri);
    ...
    static /* synthetic */ class C13082 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f122x6ba3e28f     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f122x6ba3e28f     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.screenshot.LongScreenshotActivity.C13082.<clinit>():void");
        }
    }
