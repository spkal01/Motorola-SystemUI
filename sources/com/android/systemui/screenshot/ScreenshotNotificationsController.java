...
public class ScreenshotNotificationsController {
    ...
    public void notifyScreenshotError(int i) {
        notifyScreenshotError(i, (String) null, 0);
    }

    public void notifyScreenshotError(int i, String str, int i2) {
        ScreenshotHelperEx.onScreenshotFinished(this.mContext, false, (Uri) null, str, i2);
        if (!ScreenshotHelper.isSilentType(i2)) {
            Resources resources = this.mContext.getResources();
            String string = resources.getString(i);
            Notification.Builder builder = new Notification.Builder(this.mContext, NotificationChannels.ALERTS);
            int i3 = R$string.screenshot_failed_title;
            Notification.Builder color = builder.setTicker(resources.getString(i3)).setContentTitle(resources.getString(i3)).setContentText(string).setSmallIcon(R$drawable.stat_notify_image_error).setWhen(System.currentTimeMillis()).setVisibility(1).setCategory("err").setAutoCancel(true).setColor(this.mContext.getColor(17170460));
