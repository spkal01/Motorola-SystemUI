...
class SaveImageInBackgroundTask extends AsyncTask<Void, Void, Void> {
    ...
    public Void doInBackground(Void... voidArr) {
        ...
        try {
            ...
            String str2 = this.mParams.focusedAppPackageName;
            if (TextUtils.isEmpty(str2)) {
                str2 = MomentsHelper.getTopPackage();
            }
            MomentsHelper.insertMoments(this.mContext, str2, 1, uri);
            ...
            savedImageData4.googleLensAction = createGoogleLensAction(context4, context4.getResources(), uri);
            this.mParams.mActionsReadyListener.onActionsReady(this.mImageData);
            this.mParams.finisher.accept(this.mImageData.uri);
            this.mParams.image.recycle();
    ...
    public /* synthetic */ ScreenshotController.SavedImageData.ActionTransition lambda$createEditAction$1(Context context, Uri uri, Resources resources) {
        ...
        if (!TextUtils.isEmpty(string)) {
            ...
            intent.setComponent(ComponentName.unflattenFromString("com.motorola.screenshoteditor/.MainActivity"));
    ...
    /* access modifiers changed from: package-private */
    @VisibleForTesting
    public Notification.Action createGoogleLensAction(Context context, Resources resources, Uri uri) {
        Intent intent = new Intent(this.mContext, LensRouterActivity.class);
        intent.setDataAndType(uri, "image/png");
        intent.addFlags(268533761);
        return new Notification.Action.Builder(Icon.createWithResource(resources, R$drawable.ic_screenshot_edit), resources.getString(17041386), PendingIntent.getBroadcastAsUser(context, this.mContext.getUserId(), new Intent(context, ActionProxyReceiver.class).putExtra("android:screenshot_action_intent", PendingIntent.getActivityAsUser(context, 0, intent, 67108864, (Bundle) null, UserHandle.CURRENT)).putExtra("android:screenshot_cancel_notification", intent.getComponent() != null).putExtra("android:screenshot_id", this.mScreenshotId).putExtra("android:smart_actions_enabled", false).addFlags(268435456), 335544320, UserHandle.SYSTEM)).build();
    }
}
