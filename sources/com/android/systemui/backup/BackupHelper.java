...
public final class BackupHelper extends BackupAgentHelper {
    ...
    public void onCreate(@NotNull UserHandle userHandle, int i) {
        ...
        super.onCreate();
        addHelper("systemui.files_no_overwrite", new NoOverwriteFileBackupHelper(Companion.getControlsDataLock(), this, MapsKt__MapsJVMKt.mapOf(TuplesKt.m104to("controls_favorites.xml", BackupHelperKt.getPPControlsFile(this)))));
    ...
    private static final class NoOverwriteFileBackupHelper extends FileBackupHelper {
        ...
        public NoOverwriteFileBackupHelper(@org.jetbrains.annotations.NotNull java.lang.Object r5, @org.jetbrains.annotations.NotNull android.content.Context r6, @org.jetbrains.annotations.NotNull java.util.Map<java.lang.String, ? extends kotlin.jvm.functions.Function0<kotlin.Unit>> r7) {
            /*
                r4 = this;
