    ...
    static /* synthetic */ class C09161 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.doze.DozeFalsingManagerAdapter.C09161.<clinit>():void");
        }
    }

    private boolean isAodMode(DozeMachine.State state) {
        int i = C09161.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state.ordinal()];
        return i == 1 || i == 2 || i == 3;
    }
}
