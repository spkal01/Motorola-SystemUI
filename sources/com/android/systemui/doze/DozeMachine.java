...
public class DozeMachine {
    ...
    static /* synthetic */ class C09181 {
        ...
        static {
            ...
            L_0x0090:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.doze.DozeMachine.C09181.<clinit>():void");
        }
    }
    ...
    public enum State {
        ...
        public boolean canPulse() {
            int i = C09181.$SwitchMap$com$android$systemui$doze$DozeMachine$State[ordinal()];
        ...
        public int screenState(DozeParameters dozeParameters) {
            switch (C09181.$SwitchMap$com$android$systemui$doze$DozeMachine$State[ordinal()]) {
                case 1:
                case 3:
                    return 1;
                case 2:
    ...
    public void requestPulseForCli(int i) {
        if (this.mDozeHost.isPulsingBlocked() || !canPulse()) {
            Log.w("DozeMachine", "isPulsingBlocked:" + this.mDozeHost.isPulsingBlocked() + " canPulse:" + canPulse());
            return;
        }
        requestPulse(i);
    }
    ...
    private boolean canPulse() {
        ...
        return state == State.DOZE || state == State.DOZE_AOD || state == State.DOZE_AOD_DOCKED;
    }
    ...
    private void performTransitionOnComponents(State state, State state2) {
        ...
        if (C09181.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state2.ordinal()] == 11) {
    ...
    private void validateTransition(State state) {
        try {
            int[] iArr = C09181.$SwitchMap$com$android$systemui$doze$DozeMachine$State;
            ...
            if (i2 == 7) {
                ...
                if (!(state2 == State.DOZE_REQUEST_PULSE || state2 == State.DOZE_PULSING)) {
                    if (state2 != State.DOZE_PULSING_BRIGHT) {
                        z = false;
                    }
                }
                Preconditions.checkState(z);
    ...
    private void resolveIntermediateState(State state) {
        State state2;
        int i = C09181.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state.ordinal()];
        if (i == 10 || i == 12) {
