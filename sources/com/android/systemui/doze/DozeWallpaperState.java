...
public class DozeWallpaperState implements DozeMachine.Part {
    ...
    static /* synthetic */ class C09281 {
        ...
        static {
            ...
            L_0x006c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.doze.DozeWallpaperState.C09281.<clinit>():void");
        }
    }
    ...
    public void transitionTo(DozeMachine.State state, DozeMachine.State state2) {
        ...
        boolean z2;
        boolean z3 = false;
        switch (C09281.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
