...
final class ActivityLaunchAnimator$Runner$startAnimation$2 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        if (!this.this$0.cancelled) {
            ...
            float access$lerp = this.this$0.lerp(this.$startWidth, this.$endWidth, interpolation) / ((float) 2);
            ...
            this.$state.setLeft(MathKt__MathJVMKt.roundToInt(lerp - access$lerp));
            this.$state.setRight(MathKt__MathJVMKt.roundToInt(lerp + access$lerp));
