...
public final class C0913xb22f7179 implements Factory<AccessibilityFloatingMenuController> {
    ...
    public C0913xb22f7179(DependencyProvider dependencyProvider, Provider<Context> provider, Provider<AccessibilityButtonTargetsObserver> provider2, Provider<AccessibilityButtonModeObserver> provider3, Provider<KeyguardUpdateMonitor> provider4) {
    ...
    public static C0913xb22f7179 create(DependencyProvider dependencyProvider, Provider<Context> provider, Provider<AccessibilityButtonTargetsObserver> provider2, Provider<AccessibilityButtonModeObserver> provider3, Provider<KeyguardUpdateMonitor> provider4) {
        return new C0913xb22f7179(dependencyProvider, provider, provider2, provider3, provider4);
    }
