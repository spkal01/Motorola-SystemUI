...
public class DependencyProvider {
    ...
    static ThemeOverlayApplier provideThemeOverlayManager(Context context, Executor executor, OverlayManager overlayManager, DumpManager dumpManager) {
    ...
    public MotoDisplayManager provideMotoDisplayManager(Context context, DozeHost dozeHost) {
        return new MotoDisplayManager(context, dozeHost);
    }

    public DualSimIconController provideDualSimIconController(Context context) {
        return new DualSimIconController(context);
    }
}
