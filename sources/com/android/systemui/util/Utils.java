...
public class Utils {
    ...
    public static boolean isDeviceProvisionedInDB(Context context) {
        return Settings.Global.getInt(context.getContentResolver(), "device_provisioned", 0) != 0;
    }

    public static boolean useQsMediaPlayer(Context context) {
        if (!MotoFeature.getInstance(context).isCustomPanelView() && Settings.Global.getInt(context.getContentResolver(), "qs_media_controls", 1) > 0) {
            return true;
        }
        return false;
    }
