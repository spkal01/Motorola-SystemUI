...
public final /* synthetic */ class NavBarTuner$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ NavBarTuner$$ExternalSyntheticLambda6(NavBarTuner navBarTuner, String str, ListPreference listPreference, Preference preference, ListPreference listPreference2) {
    ...
    public final void run() {
        this.f$0.lambda$bindButton$6(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
