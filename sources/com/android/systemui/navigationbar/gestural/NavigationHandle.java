...
public class NavigationHandle extends View implements ButtonInterface {
    ...
    public void onFinishInflate() {
        ...
        if (isSupportCli && context.getDisplayId() == 1) {
            this.mRadius = resources.getDimensionPixelSize(R$dimen.cli_navigation_handle_radius);
            ViewGroup.LayoutParams layoutParams = getLayoutParams();
            if (layoutParams != null) {
                layoutParams.width = resources.getDimensionPixelSize(R$dimen.cli_navigation_home_handle_width);
