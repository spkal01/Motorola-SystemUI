...
public class NavigationBarInflaterView extends FrameLayout implements NavigationModeController.ModeChangedListener {
    ...
    private ContentObserver mNavLayoutObserver = new ContentObserver((Handler) null) {
        /* access modifiers changed from: private */
        public /* synthetic */ void lambda$onChange$0() {
            NavigationBarInflaterView.this.onLikelyDefaultLayoutChange();
        }

        public void onChange(boolean z) {
            NavigationBarInflaterView.this.post(new NavigationBarInflaterView$1$$ExternalSyntheticLambda0(this));
        }
    };
    ...
    public NavigationBarInflaterView(Context context, AttributeSet attributeSet) {
        ...
        this.mNavigationModeController = (NavigationModeController) Dependency.get(cls);
    }
    ...
    public String getDefaultLayout() {
        int i;
        boolean isInvert3Buttons = isInvert3Buttons();
        ...
        } else if (isInvert3Buttons) {
            i = R$string.config_invertNavBarLayout;
        } else {
    ...
    public void onNavigationModeChanged(int i) {
        this.mNavBarMode = i;
        if (this.mNavigationModeController.isGestureHided() && QuickStepContract.isGesturalMode(this.mNavBarMode) && !this.mNavigationModeController.isTrackpadIconShow()) {
            setVisibility(4);
        }
        onLikelyDefaultLayoutChange();
    }

    private boolean isInvert3Buttons() {
        if (MotorolaSettings.Secure.getIntForUser(this.mContext.getContentResolver(), "three_button_layout_direction", 0, -2) == 1) {
            return true;
        }
        return false;
    }
    ...
    public void onAttachedToWindow() {
        ...
        this.mContext.getContentResolver().registerContentObserver(MotorolaSettings.Secure.getUriFor("three_button_layout_direction"), false, this.mNavLayoutObserver, -2);
    }

    /* access modifiers changed from: protected */
    public void onDetachedFromWindow() {
        ((NavigationModeController) Dependency.get(NavigationModeController.class)).removeListener(this);
        this.mContext.getContentResolver().unregisterContentObserver(this.mNavLayoutObserver);
    ...
    private void updateAlternativeOrder() {
        ...
        int i3 = R$id.custom_group;
        updateAlternativeOrder(frameLayout3.findViewById(i3));
        updateAlternativeOrder(this.mVertical.findViewById(i));
        updateAlternativeOrder(this.mVertical.findViewById(i2));
        updateAlternativeOrder(this.mVertical.findViewById(i3));
    }
    ...
    public void inflateLayout(String str) {
        ...
        if (this.mIsMotoTaskBarAvailable) {
            FrameLayout frameLayout2 = this.mHorizontal;
            int i2 = R$id.custom_group;
            inflateButtons(new String[]{"trackpad"}, (ViewGroup) frameLayout2.findViewById(i2), false, true);
            inflateButtons(new String[]{"trackpad"}, (ViewGroup) this.mVertical.findViewById(i2), true, true);
            addGravitySpacer((LinearLayout) this.mHorizontal.findViewById(i2));
            addGravitySpacer((LinearLayout) this.mVertical.findViewById(i2));
        }
        FrameLayout frameLayout3 = this.mHorizontal;
        int i3 = R$id.center_group;
        inflateButtons(split3, (ViewGroup) frameLayout3.findViewById(i3), false, false);
        inflateButtons(split3, (ViewGroup) this.mVertical.findViewById(i3), true, false);
    ...
    public View createView(String str, ViewGroup viewGroup, LayoutInflater layoutInflater) {
        ...
        if ("trackpad".equals(extractButton)) {
            return layoutInflater.inflate(R$layout.zz_moto_trackpad, viewGroup, false);
        }
