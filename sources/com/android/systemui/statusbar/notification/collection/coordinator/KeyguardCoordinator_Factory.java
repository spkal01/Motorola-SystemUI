...
public final class KeyguardCoordinator_Factory implements Factory<KeyguardCoordinator> {
    ...
    public static KeyguardCoordinator newInstance(Context context, Handler handler, KeyguardStateController keyguardStateController, NotificationLockscreenUserManager notificationLockscreenUserManager, BroadcastDispatcher broadcastDispatcher, StatusBarStateController statusBarStateController, KeyguardUpdateMonitor keyguardUpdateMonitor, HighPriorityProvider highPriorityProvider2) {
        return new KeyguardCoordinator(context, handler, keyguardStateController, notificationLockscreenUserManager, broadcastDispatcher, statusBarStateController, keyguardUpdateMonitor, highPriorityProvider2);
    }
}
