...
public final class HeadsUpCoordinator_Factory implements Factory<HeadsUpCoordinator> {
    ...
    public static HeadsUpCoordinator newInstance(HeadsUpManager headsUpManager, HeadsUpViewBinder headsUpViewBinder, NotificationInterruptStateProvider notificationInterruptStateProvider2, NotificationRemoteInputManager notificationRemoteInputManager, NodeController nodeController) {
        return new HeadsUpCoordinator(headsUpManager, headsUpViewBinder, notificationInterruptStateProvider2, notificationRemoteInputManager, nodeController);
    }
}
