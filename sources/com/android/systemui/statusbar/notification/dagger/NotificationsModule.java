...
import com.motorola.systemui.desktop.overwrites.statusbar.notification.interruption.DesktopNotificationInterruptStateProviderImpl;
...
public interface NotificationsModule {
    ...
    static NotificationInterruptStateProvider provideNotificationInterruptStateProvider(Context context, NotificationInterruptStateProviderImpl notificationInterruptStateProviderImpl, PowerManager powerManager, IDreamManager iDreamManager, HeadsUpManager headsUpManager, NotificationFilter notificationFilter) {
        return context instanceof DesktopDisplayContext ? new DesktopNotificationInterruptStateProviderImpl(powerManager, iDreamManager, headsUpManager, notificationFilter) : notificationInterruptStateProviderImpl;
    }
}
