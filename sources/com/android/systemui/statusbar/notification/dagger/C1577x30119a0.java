...
public final class C1577x30119a0 implements Factory<NodeController> {
    private final Provider<SectionHeaderControllerSubcomponent> subcomponentProvider;

    public C1577x30119a0(Provider<SectionHeaderControllerSubcomponent> provider) {
    ...
    public static C1577x30119a0 create(Provider<SectionHeaderControllerSubcomponent> provider) {
        return new C1577x30119a0(provider);
    }
