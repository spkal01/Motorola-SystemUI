...
public abstract class AnimatableProperty {
    ...
    /* renamed from: X */
    public static final AnimatableProperty f130X;

    /* renamed from: Y */
    public static final AnimatableProperty f131Y = from(View.Y, R$id.y_animator_tag, R$id.y_animator_tag_start_value, R$id.y_animator_tag_end_value);
    ...
    public static <T extends View> AnimatableProperty from(String str, final BiConsumer<T, Float> biConsumer, final Function<T, Float> function, final int i, final int i2, final int i3) {
        final C15075 r0 = new FloatProperty<T>(str) {
