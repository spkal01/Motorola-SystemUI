...
public class NotificationGutsManager implements Dumpable, NotificationLifetimeExtender {
    ...
    public boolean bindGuts(ExpandableNotificationRow expandableNotificationRow, NotificationMenuRowPlugin.MenuItem menuItem) {
        ...
        expandableNotificationRow.getGuts().setClosedListener(new NotificationGutsManager$$ExternalSyntheticLambda2(this, expandableNotificationRow, sbn));
    ...
    private void initializeSnoozeView(ExpandableNotificationRow expandableNotificationRow, NotificationSnooze notificationSnooze) {
        ...
        guts.setHeightChangedListener(new NotificationGutsManager$$ExternalSyntheticLambda3(this, expandableNotificationRow));
    }
    ...
    public void initializeNotificationInfo(ExpandableNotificationRow expandableNotificationRow, NotificationInfo notificationInfo) throws Exception {
        ...
        NotificationGutsManager$$ExternalSyntheticLambda4 notificationGutsManager$$ExternalSyntheticLambda4 = new NotificationGutsManager$$ExternalSyntheticLambda4(this, guts, sbn, expandableNotificationRow);
    ...
    public void initializeConversationNotificationInfo(ExpandableNotificationRow expandableNotificationRow, NotificationConversationInfo notificationConversationInfo) throws Exception {
        ...
        UserHandle user = sbn.getUser();
        PackageManager packageManagerForUser = StatusBar.getPackageManagerForUser(this.mContext, user.getIdentifier());
        NotificationGutsManager$$ExternalSyntheticLambda0 notificationGutsManager$$ExternalSyntheticLambda0 = new NotificationGutsManager$$ExternalSyntheticLambda0(this, sbn, expandableNotificationRow);
        if (!user.equals(UserHandle.ALL) || this.mLockscreenUserManager.getCurrentUserId() == 0) {
            notificationGutsManager$$ExternalSyntheticLambda1 = new NotificationGutsManager$$ExternalSyntheticLambda1(this, guts, sbn, packageName, expandableNotificationRow);
        } else {
    ...
    public boolean openGuts(View view, int i, int i2, NotificationMenuRowPlugin.MenuItem menuItem) {
        ...
        this.mStatusBarLazy.get().executeRunnableDismissingKeyguard(new NotificationGutsManager$$ExternalSyntheticLambda8(this, view, i, i2, menuItem), (Runnable) null, false, true, true);
        return true;
    }

    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$openGuts$9(View view, int i, int i2, NotificationMenuRowPlugin.MenuItem menuItem) {
        this.mMainHandler.post(new NotificationGutsManager$$ExternalSyntheticLambda7(this, view, i, i2, menuItem));
    }

    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$openGuts$8(View view, int i, int i2, NotificationMenuRowPlugin.MenuItem menuItem) {
        if (MotoFeature.getInstance(this.mContext).isCustomPanelView()) {
            Log.i("NotificationGutsManager", "PrcPanel openGuts  Runnable");
            NotificationPanelViewController panelController = ((StatusBar) Dependency.get(StatusBar.class)).getPanelController();
            if (panelController != null) {
                panelController.updatePanelViewState(1);
            }
        }
