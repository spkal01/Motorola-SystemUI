...
public abstract class ExpandableView extends FrameLayout implements Dumpable {
    ...
    private boolean mIsCliRow = false;
    ...
    public void setCliRow() {
        this.mIsCliRow = true;
        this.mCliMinHeight = getResources().getDimensionPixelSize(R$dimen.cli_row_min_height);
    }

    public boolean isCliRow() {
        return this.mIsCliRow;
    }

    public int getCliMinHeight() {
        return this.mCliMinHeight;
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (i7 != -1) {
                    childAt.measure(FrameLayout.getChildMeasureSpec(i, paddingStart, layoutParams.width), i7 >= 0 ? View.MeasureSpec.makeMeasureSpec(Math.min(i7, i4), 1073741824) : makeMeasureSpec);
        ...
        if (isCliRow() && size < (i3 = this.mCliMinHeight)) {
            size = i3;
        }
