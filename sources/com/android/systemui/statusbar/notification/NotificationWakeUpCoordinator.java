...
public final class NotificationWakeUpCoordinator implements OnHeadsUpChangedListener, StatusBarStateController.StateListener, PanelExpansionListener {
    ...
    public NotificationWakeUpCoordinator(@NotNull HeadsUpManager headsUpManager, @NotNull StatusBarStateController statusBarStateController2, @NotNull KeyguardBypassController keyguardBypassController, @NotNull DozeParameters dozeParameters2, @NotNull UnlockedScreenOffAnimationController unlockedScreenOffAnimationController2) {
    ...
    public final void setStackScroller(@NotNull NotificationStackScrollLayoutController notificationStackScrollLayoutController) {
        ...
        notificationStackScrollLayoutController.setOnPulseHeightChangedListener(new NotificationWakeUpCoordinator$setStackScroller$1(this));
    }
