...
public class NotificationChildrenContainer extends ViewGroup {
    ...
    private void initDimens() {
        ...
        this.mCollapsedBottompadding = (float) resources.getDimensionPixelSize(17105384);
        ...
        this.mTranslationForHeader = resources.getDimensionPixelSize(17105384) - this.mNotificationHeaderMargin;
    ...
    public void addNotification(ExpandableNotificationRow expandableNotificationRow, int i) {
        ...
        ViewGroup viewGroup = (ViewGroup) expandableNotificationRow.getParent();
        if (viewGroup != null) {
            viewGroup.removeView(expandableNotificationRow);
        }
    ...
    public void updateState(com.android.systemui.statusbar.notification.stack.ExpandableViewState r19, com.android.systemui.statusbar.notification.stack.AmbientState r20) {
        ...
        L_0x00a9:
            ...
            boolean r15 = r18.showingAsLowPriority()
        ...
        L_0x0175:
            r2.zTranslation = r10
            int r1 = r0.mCurrentHeaderTranslation
            float r1 = (float) r1
            r2.yTranslation = r1
    ...
    public void applyState() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            viewState.hidden = !z;
            viewState.alpha = f;
            if (expandableNotificationRow.isCliRow()) {
                viewState.hidden = !this.mChildrenExpanded;
