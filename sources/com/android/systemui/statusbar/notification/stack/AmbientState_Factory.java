...
public final class AmbientState_Factory implements Factory<AmbientState> {
    ...
    public static AmbientState newInstance(Context context, StackScrollAlgorithm.SectionProvider sectionProvider2, StackScrollAlgorithm.BypassController bypassController) {
        return new AmbientState(context, sectionProvider2, bypassController);
    }
}
