...
public final class SystemEventChipAnimationController {
    ...
    public SystemEventChipAnimationController(@NotNull Context context2, @NotNull SuperStatusBarViewFactory superStatusBarViewFactory, @NotNull StatusBarWindowController statusBarWindowController2, @NotNull StatusBarLocationPublisher statusBarLocationPublisher) {
    ...
    public void onChipAnimationStart(@NotNull Function1<? super Context, ? extends View> function1, int i) {
    ...
    public void onChipAnimationUpdate(@NotNull ValueAnimator valueAnimator, int i) {
    ...
    private final void init() {
        ...
        StatusBarWindowView statusBarWindowView2 = this.statusBarViewFactory.getStatusBarWindowView();
        Intrinsics.checkNotNullExpressionValue(statusBarWindowView2, "statusBarViewFactory.statusBarWindowView");
        this.statusBarWindowView = statusBarWindowView2;
        ...
        StatusBarWindowView statusBarWindowView3 = this.statusBarWindowView;
        if (statusBarWindowView3 != null) {
            FrameLayout frameLayout2 = this.animationWindowView;
            if (frameLayout2 != null) {
                statusBarWindowView3.addView(frameLayout2, layoutParams);
            } else {
                Intrinsics.throwUninitializedPropertyAccessException("animationWindowView");
                throw null;
            }
