        ...
        if (view2 != view) {
            ...
            if (view != null) {
                if (this.mLaunchingAffordance) {
                    i = view2 == null ? 0 : view2.getVisibility();
                } else {
                    i = 4;
                }
    ...
    public void finishAnimation(float f, final Runnable runnable) {
        ...
        if (view != null) {
            ...
            if (getVisibility() == 0) {
                ...
                this.mPreviewClipper = ViewAnimationUtils.createCircularReveal(this.mPreviewView, getScreenWidth(), getScreenHeight(), this.mCircleRadius, maxCircleSize);
            }
