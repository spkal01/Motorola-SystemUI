...
public final class KeyboardShortcuts {
    ...
    public static void toggle(Context context, int i) {
        ...
        synchronized (sLock) {
            if (MotoDesktopManager.isDesktopSupported()) {
                if (!isShowing() || (keyboardShortcuts = sInstance) == null || keyboardShortcuts.mContext.getDisplayId() != context.getDisplayId()) {
                    show(context, i);
                } else {
                    dismiss();
                }
    ...
    private void loadResources(Context context) {
        ...
        sparseArray.put(66, context2.getString(i));
        ...
        sparseArray2.put(96, context2.getString(i2, new Object[]{"A"}));
        this.mSpecialCharacterNames.put(97, context2.getString(i2, new Object[]{"B"}));
        this.mSpecialCharacterNames.put(98, context2.getString(i2, new Object[]{"C"}));
        this.mSpecialCharacterNames.put(99, context2.getString(i2, new Object[]{"X"}));
        this.mSpecialCharacterNames.put(100, context2.getString(i2, new Object[]{"Y"}));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginRight, context2.getString(i2, new Object[]{"Z"}));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginStart, context2.getString(i2, new Object[]{"L1"}));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginTop, context2.getString(i2, new Object[]{"R1"}));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_motionStagger, context2.getString(i2, new Object[]{"L2"}));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_pathMotionArc, context2.getString(i2, new Object[]{"R2"}));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_transitionEasing, context2.getString(i2, new Object[]{"Start"}));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_transitionPathRotate, context2.getString(i2, new Object[]{"Select"}));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_visibilityMode, context2.getString(i2, new Object[]{"Mode"}));
        this.mSpecialCharacterNames.put(112, context2.getString(R$string.keyboard_key_forward_del));
        ...
        this.mSpecialCharacterNames.put(androidx.appcompat.R$styleable.AppCompatTheme_windowFixedWidthMajor, context2.getString(R$string.keyboard_key_move_home));
        this.mSpecialCharacterNames.put(androidx.appcompat.R$styleable.AppCompatTheme_windowFixedWidthMinor, context2.getString(R$string.keyboard_key_move_end));
        this.mSpecialCharacterNames.put(androidx.appcompat.R$styleable.AppCompatTheme_windowMinWidthMajor, context2.getString(R$string.keyboard_key_insert));
        ...
        sparseArray3.put(144, context2.getString(i3, new Object[]{"0"}));
        this.mSpecialCharacterNames.put(145, context2.getString(i3, new Object[]{"1"}));
        this.mSpecialCharacterNames.put(146, context2.getString(i3, new Object[]{"2"}));
        this.mSpecialCharacterNames.put(147, context2.getString(i3, new Object[]{"3"}));
        this.mSpecialCharacterNames.put(148, context2.getString(i3, new Object[]{"4"}));
        this.mSpecialCharacterNames.put(149, context2.getString(i3, new Object[]{"5"}));
        this.mSpecialCharacterNames.put(150, context2.getString(i3, new Object[]{"6"}));
        this.mSpecialCharacterNames.put(151, context2.getString(i3, new Object[]{"7"}));
        this.mSpecialCharacterNames.put(152, context2.getString(i3, new Object[]{"8"}));
        this.mSpecialCharacterNames.put(153, context2.getString(i3, new Object[]{"9"}));
        this.mSpecialCharacterNames.put(154, context2.getString(i3, new Object[]{"/"}));
        this.mSpecialCharacterNames.put(155, context2.getString(i3, new Object[]{"*"}));
        this.mSpecialCharacterNames.put(156, context2.getString(i3, new Object[]{"-"}));
        this.mSpecialCharacterNames.put(157, context2.getString(i3, new Object[]{"+"}));
        this.mSpecialCharacterNames.put(158, context2.getString(i3, new Object[]{"."}));
        this.mSpecialCharacterNames.put(159, context2.getString(i3, new Object[]{","}));
        this.mSpecialCharacterNames.put(160, context2.getString(i3, new Object[]{context2.getString(i)}));
        this.mSpecialCharacterNames.put(161, context2.getString(i3, new Object[]{"="}));
        this.mSpecialCharacterNames.put(162, context2.getString(i3, new Object[]{"("}));
        this.mSpecialCharacterNames.put(163, context2.getString(i3, new Object[]{")"}));
    ...
    private void populateKeyboardShortcuts(LinearLayout linearLayout, List<KeyboardShortcutGroup> list) {
        ...
        while (i9 < size) {
            ...
            if (keyboardShortcutGroup2.isSystemGroup()) {
                ...
                colorStateList = ColorStateList.valueOf(this.mContext.getColor(R$color.ksh_application_group_color));
            }
