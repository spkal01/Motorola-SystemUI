...
public final class RippleShader extends RuntimeShader {
    ...
    public final void setProgress(float f) {
        ...
        float access$subProgress3 = companion.subProgress(0.3f, 1.0f, f);
        float access$subProgress4 = companion.subProgress(0.0f, 0.2f, f);
        setUniform("in_fadeSparkle", Math.min(access$subProgress, f2 - access$subProgress2));
        setUniform("in_fadeCircle", f2 - access$subProgress4);
        setUniform("in_fadeRing", Math.min(access$subProgress, f2 - access$subProgress3));
    }
