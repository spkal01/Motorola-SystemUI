...
public class HeadsUpTouchHelper implements Gefingerpoken {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        NotificationPanelViewController panelController;
        ...
        if (actionMasked != 0) {
            ...
            if (childAtRawPosition instanceof ExpandableNotificationRow) {
                ...
                boolean z2 = !this.mCallback.isExpanded() && expandableNotificationRow2.isHeadsUp() && expandableNotificationRow2.isPinned();
            ...
            if (MotoFeature.getInstance(this.mCallback.getContext()).isCustomPanelView() && this.mTouchingHeadsUpView && (panelController = ((StatusBar) Dependency.get(StatusBar.class)).getPanelController()) != null) {
