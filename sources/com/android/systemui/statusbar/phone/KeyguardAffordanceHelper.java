...
public class KeyguardAffordanceHelper {
    ...
    private boolean mForceShowAnimate;
    ...
    public void setForceShowAnimate(boolean z) {
        this.mForceShowAnimate = z;
    }
    ...
    public void launchAffordance(boolean z, boolean z2) {
        ...
        if (!this.mSwipingInProgress) {
            ...
            if (keyguardAffordanceView.getVisibility() != 0 && !this.mForceShowAnimate) {
                z = false;
            }
            this.mForceShowAnimate = false;
            if (z) {
                fling(0.0f, false, !z2);
