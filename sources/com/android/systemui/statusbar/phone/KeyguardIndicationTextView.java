...
public class KeyguardIndicationTextView extends TextView {
    ...
    public LinkedList<KeyguardIndication> mKeyguardIndicationInfo = new LinkedList<>();
    /* access modifiers changed from: private */
    public LinkedList<CharSequence> mMessages = new LinkedList<>();
    ...
    public void switchIndication(CharSequence charSequence, KeyguardIndication keyguardIndication) {
        ...
        if (peekLast != null || !TextUtils.equals(charSequence, getText())) {
            ...
            long max = Math.max(0, this.mNextAnimationTime - currentTimeMillis);
