    ...
    private static final Rect getStatusBarLeftRight(DisplayCutout displayCutout, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        for (Rect next : list) {
            ...
            if (shareShortEdge(sbRect, next, i4, i5)) {
                if (touchesLeftEdge(next, i10, i4, i5)) {
                    i11 = Math.max(Math.max(i6, logicalWidth(next, i10)), i11);
                } else if (touchesRightEdge(next, i10, i4, i5)) {
                    i12 = Math.max(i7, logicalWidth(next, i10));
                }
            }
        }
