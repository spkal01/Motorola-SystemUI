...
public final class C1496x30c882de implements Factory<NotificationMediaManager> {
    ...
    public static C1496x30c882de create(Provider<Context> provider, Provider<StatusBar> provider2, Provider<NotificationShadeWindowController> provider3, Provider<NotificationEntryManager> provider4, Provider<MediaArtworkProcessor> provider5, Provider<KeyguardBypassController> provider6, Provider<NotifPipeline> provider7, Provider<NotifCollection> provider8, Provider<FeatureFlags> provider9, Provider<DelayableExecutor> provider10, Provider<DeviceConfigProxy> provider11, Provider<MediaDataManager> provider12) {
        return new C1496x30c882de(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12);
    }
