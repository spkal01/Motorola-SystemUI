...
public class UserInfoControllerImpl implements UserInfoController {
    ...
    public UserInfoControllerImpl(Context context) {
        C20681 r0 = new BroadcastReceiver() {
        ...
        this.mReceiver = r0;
        C20692 r2 = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
        ...
        context.registerReceiverAsUser(r2, UserHandle.ALL, intentFilter2, (String) null, (Handler) null);
    }
    ...
    private void queryForUserInformation() {
        try {
            ...
            C20703 r6 = new AsyncTask<Void, Void, UserInfoQueryResult>() {
