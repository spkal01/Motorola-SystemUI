...
public class HotspotControllerImpl implements HotspotController, WifiManager.SoftApCallback {
    ...
    public void addCallback(com.android.systemui.statusbar.policy.HotspotController.Callback r5) {
        ...
        L_0x0047:
            ...
            com.android.systemui.statusbar.policy.HotspotControllerImpl$$ExternalSyntheticLambda0 r2 = new com.android.systemui.statusbar.policy.HotspotControllerImpl$$ExternalSyntheticLambda0     // Catch:{ all -> 0x0055 }
            r2.<init>(r4, r5)     // Catch:{ all -> 0x0055 }
    ...
    public void fireHotspotChangedCallback() {
        ...
        for (HotspotController.Callback onHotspotChanged : arrayList) {
            onHotspotChanged.onHotspotChanged(isHotspotEnabled(), this.mNumConnectedDevices);
        }
    }
    ...
    public void onStateChanged(int i, int i2) {
        ...
        if (!isHotspotEnabled()) {
            ...
            this.mWifiManager.setSoftApConfiguration(new SoftApConfiguration.Builder(this.mWifiManager.getSoftApConfiguration()).setBlockedClientList(new ArrayList()).build());
        }
    ...
    public void onBlockedClientConnecting(WifiClient wifiClient, int i) {
        if (1 == i) {
            Intent intent = new Intent("com.motorola.net.wifi.MAX_DEVICES_ALERT");
            intent.setClassName("com.motorola.carriersettingsext", "com.motorola.carriersettingsext.hotspot.WifiApMaxDeviceReceiver");
