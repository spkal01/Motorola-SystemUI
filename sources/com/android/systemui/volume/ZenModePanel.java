...
public class ZenModePanel extends FrameLayout {
    ...
    /* access modifiers changed from: private */
    public final C2184H mHandler = new C2184H();
    ...
    protected final SegmentedButtons.Callback mZenButtonsCallback = new SegmentedButtons.Callback() {
        public void onSelected(Object obj, boolean z) {
            if (obj != null && ZenModePanel.this.mZenButtons.isShown() && ZenModePanel.this.isAttachedToWindow()) {
                ...
                final Uri access$2100 = zenModePanel.getRealConditionId(zenModePanel.mSessionExitCondition);
                AsyncTask.execute(new Runnable() {
                    public void run() {
                        ZenModePanel.this.mController.setZen(intValue, access$2100, "ZenModePanel.selectZen");
                        if (intValue != 0) {
    ...
    public ZenModePanel(Context context, AttributeSet attributeSet) {
        ...
        this.mVoiceCapable = Util.isVoiceCapable(context);
    ...
    public void onFinishInflate() {
        ...
        findViewById.setOnClickListener(new ZenModePanel$$ExternalSyntheticLambda1(this));
        TextView textView = (TextView) findViewById(R$id.zen_introduction_customize);
        this.mZenIntroductionCustomize = textView;
        textView.setOnClickListener(new ZenModePanel$$ExternalSyntheticLambda0(this));
    ...
    public void setEmptyState(int i, int i2) {
        this.mEmptyIcon.post(new ZenModePanel$$ExternalSyntheticLambda4(this, i, i2));
    }
    ...
    public void setAutoText(CharSequence charSequence) {
        this.mAutoTitle.post(new ZenModePanel$$ExternalSyntheticLambda5(this, charSequence));
    }
    ...
    private void transitionFrom(View view, View view2) {
        view.post(new ZenModePanel$$ExternalSyntheticLambda3(view2, view));
    }
    ...
    public static /* synthetic */ void lambda$transitionFrom$5(View view, View view2) {
        ...
        view.bringToFront();
        view.animate().cancel();
        view.animate().alpha(1.0f).setDuration(300).withEndAction(new ZenModePanel$$ExternalSyntheticLambda2(view2)).start();
    }
    ...
    private String computeAlarmWarningText(boolean z) {
        ...
        return getResources().getString(i, new Object[]{getResources().getString(z2 ? R$string.alarm_template : R$string.alarm_template_far, new Object[]{DateFormat.format(DateFormat.getBestDateTimePattern(Locale.getDefault(), z2 ? is24HourFormat ? "Hm" : "hma" : is24HourFormat ? "EEEHm" : "EEEhma"), nextAlarm)})});
    }
    ...
    private static String foreverSummary(Context context) {
        return context.getString(17041738);
    }
    ...
    private void bind(Condition condition, View view, int i) {
        ...
        if (condition2 != null) {
            ...
            RadioButton radioButton = conditionTag.f145rb;
            boolean z3 = radioButton == null;
            if (radioButton == null) {
                conditionTag.f145rb = (RadioButton) this.mZenRadioGroup.getChildAt(i2);
            }
            ...
            conditionTag.f145rb.setEnabled(z2);
            conditionTag.f145rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    if (ZenModePanel.this.mExpanded && z) {
                        conditionTag.f145rb.setChecked(true);
                        if (ZenModePanel.DEBUG) {
                            String access$800 = ZenModePanel.this.mTag;
            ...
            if (z3) {
                Interaction.register(conditionTag.f145rb, this.mInteractionCallback);
    ...
    public void announceConditionSelection(ConditionTag conditionTag) {
        ...
        announceForAccessibility(this.mContext.getString(R$string.zen_mode_and_condition, new Object[]{str, conditionTag.line1.getText()}));
    }

    /* access modifiers changed from: private */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0053, code lost:
        r0.mBucketIndex = r4;
        r3 = android.service.notification.ZenModeConfig.toTimeCondition(r0.mContext, r15, r17, android.app.ActivityManager.getCurrentUser(), false);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void onClickTimeButton(android.view.View r21, com.android.systemui.volume.ZenModePanel.ConditionTag r22, boolean r23, int r24) {
        /*
            r20 = this;
            r0 = r20
            r1 = r22
            ...
            com.android.internal.logging.MetricsLogger.action(r3, r4, r2)
            com.android.internal.logging.UiEventLogger r3 = r0.mUiEventLogger
        ...
        L_0x0016:
            ...
            int r5 = r4.length
            int r6 = r0.mBucketIndex
            r7 = 0
            r8 = -1
            r9 = 1
            if (r6 != r8) goto L_0x007a
            android.service.notification.Condition r4 = r1.condition
            android.net.Uri r4 = getConditionId(r4)
            long r10 = android.service.notification.ZenModeConfig.tryParseCountdownConditionId(r4)
        ...
        L_0x0053:
            ...
            r19 = 0
            android.service.notification.Condition r3 = android.service.notification.ZenModeConfig.toTimeCondition(r14, r15, r17, r18, r19)
            goto L_0x0065
        L_0x0062:
            int r7 = r7 + 1
            goto L_0x0032
        L_0x0065:
            ...
            android.service.notification.Condition r3 = android.service.notification.ZenModeConfig.toTimeCondition(r3, r2, r4)
            goto L_0x0095
        L_0x007a:
            int r5 = r5 - r9
        ...
        L_0x0095:
            ...
            r4 = r24
            r0.bind(r3, r2, r4)
            android.widget.RadioButton r2 = r1.f145rb
            r2.setChecked(r9)
            r0.select(r3)
            r0.announceConditionSelection(r1)
            return
        */
    ...
    private final class C2184H extends Handler {
        private C2184H() {
