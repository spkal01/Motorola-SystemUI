...
final class SeekBarViewModel$onSeekProgress$1 implements Runnable {
    ...
    public final void run() {
        if (this.this$0.scrubbing) {
            ...
            seekBarViewModel.set_data(SeekBarViewModel.Progress.copy$default(seekBarViewModel._data, false, false, Integer.valueOf((int) this.$position), 0, 11, (Object) null));
        }
    }
}
