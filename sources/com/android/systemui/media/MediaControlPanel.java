...
public class MediaControlPanel {
    ...
    public MediaControlPanel(Context context, Executor executor, ActivityStarter activityStarter, MediaViewController mediaViewController, SeekBarViewModel seekBarViewModel, Lazy<MediaDataManager> lazy, KeyguardDismissUtil keyguardDismissUtil, MediaOutputDialogFactory mediaOutputDialogFactory, MediaCarouselController mediaCarouselController) {
        ...
        loadDimens();
        seekBarViewModel.setLogSmartspaceClick(new MediaControlPanel$$ExternalSyntheticLambda13(this));
    }
    ...
    public void bindPlayer(MediaData mediaData, String str) {
        ...
        if (this.mPlayerViewHolder != null) {
            ...
            if (clickIntent != null) {
                this.mPlayerViewHolder.getPlayer().setOnClickListener(new MediaControlPanel$$ExternalSyntheticLambda4(this, clickIntent));
            }
            this.mPlayerViewHolder.getPlayer().setContentDescription(this.mContext.getString(R$string.controls_media_playing_item_description, new Object[]{mediaData.getSong(), mediaData.getArtist(), mediaData.getApp()}));
            ...
            seamless.setOnClickListener(new MediaControlPanel$$ExternalSyntheticLambda6(this, mediaData2));
            ...
            if (z) {
                ...
                str2 = this.mContext.getString(17040208);
            }
            ...
            this.mBackgroundExecutor.execute(new MediaControlPanel$$ExternalSyntheticLambda12(this, getController()));
            ...
            this.mPlayerViewHolder.getDismiss().setOnClickListener(new MediaControlPanel$$ExternalSyntheticLambda9(this, str3, mediaData2));
    ...
    public void bindRecommendation(SmartspaceMediaData smartspaceMediaData) {
        ...
        if (this.mRecommendationViewHolder != null) {
            ...
            try {
                ...
                boolean z5 = true;
                recommendations.setContentDescription(this.mContext.getString(R$string.controls_media_smartspace_rec_description, new Object[]{applicationLabel}));
                ...
                while (i3 < min && i4 < min) {
                    ...
                    if (smartspaceAction.getIcon() == null) {
                        ...
                        setSmartspaceRecItemOnClickListener(mediaCoverContainers.get(i4), smartspaceAction);
                        list3 = mediaCoverItems;
                        list2 = recommendations2;
                        String string = smartspaceAction.getExtras().getString("artist_name", "");
                        if (string.isEmpty()) {
                            z3 = true;
                            imageView.setContentDescription(this.mContext.getString(R$string.controls_media_smartspace_rec_item_no_artist_description, new Object[]{smartspaceAction.getTitle(), applicationLabel}));
                            list = mediaCoverContainers;
                            i = min;
                            i2 = 3;
                        } else {
                            ...
                            i2 = 3;
                            z3 = true;
                            imageView.setContentDescription(this.mContext.getString(R$string.controls_media_smartspace_rec_item_description, new Object[]{smartspaceAction.getTitle(), string, applicationLabel}));
                        }
                        if (i4 < i2) {
    ...
    private void setSmartspaceRecItemOnClickListener(View view, SmartspaceAction smartspaceAction) {
        if (view == null || smartspaceAction == null || smartspaceAction.getIntent() == null || smartspaceAction.getIntent().getExtras() == null) {
            ...
            view.setOnClickListener(new MediaControlPanel$$ExternalSyntheticLambda5(this, smartspaceAction, view));
        }
    }
