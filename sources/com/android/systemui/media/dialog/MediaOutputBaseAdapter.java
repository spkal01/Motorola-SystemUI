...
public abstract class MediaOutputBaseAdapter extends RecyclerView.Adapter<MediaDeviceBaseViewHolder> {
    ...
    abstract class MediaDeviceBaseViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(MediaDevice mediaDevice, boolean z, boolean z2, int i) {
            ...
            ThreadUtils.postOnBackgroundThread(new C1044x9ea0902(this, mediaDevice, z, z2));
        }

        /* access modifiers changed from: private */
        public /* synthetic */ void lambda$onBind$1(MediaDevice mediaDevice, boolean z, boolean z2) {
            ThreadUtils.postOnMainThread(new C1043x9ea0901(this, mediaDevice, MediaOutputBaseAdapter.this.mController.getDeviceIconCompat(mediaDevice).toIcon(MediaOutputBaseAdapter.this.mContext), z, z2));
        }
        ...
        public void setSingleLineLayout(CharSequence charSequence, boolean z) {
            ...
            if (z) {
                this.mTitleText.setTypeface(Typeface.create(MediaOutputBaseAdapter.this.mContext.getString(17039963), 0));
            } else {
                this.mTitleText.setTypeface(Typeface.create(MediaOutputBaseAdapter.this.mContext.getString(17039962), 0));
            }
        }

        /* access modifiers changed from: package-private */
        public void setTwoLineLayout(MediaDevice mediaDevice, boolean z, boolean z2, boolean z3, boolean z4) {
            setTwoLineLayout(mediaDevice, (CharSequence) null, z, z2, z3, z4);
        }

        /* access modifiers changed from: package-private */
        public void setTwoLineLayout(CharSequence charSequence, boolean z, boolean z2, boolean z3, boolean z4) {
            setTwoLineLayout((MediaDevice) null, charSequence, z, z2, z3, z4);
        }
        ...
        private void setTwoLineLayout(MediaDevice mediaDevice, CharSequence charSequence, boolean z, boolean z2, boolean z3, boolean z4) {
            ...
            if (z) {
                this.mTwoLineTitleText.setTypeface(Typeface.create(MediaOutputBaseAdapter.this.mContext.getString(17039963), 0));
            } else {
                this.mTwoLineTitleText.setTypeface(Typeface.create(MediaOutputBaseAdapter.this.mContext.getString(17039962), 0));
            }
        }
        ...
        public void initSeekbar(final MediaDevice mediaDevice) {
            ...
            this.mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                    ...
                    if (mediaDevice != null && z) {
                        MediaOutputBaseAdapter.this.mController.adjustVolume(mediaDevice, i);
                    }
                }
        ...
        public void playSwitchingAnim(final View view, final View view2) {
            ...
            if (seekBar.getVisibility() == 0 && textView.getVisibility() == 0) {
                boolean unused = MediaOutputBaseAdapter.this.mIsAnimating = true;
                textView.setTypeface(Typeface.create(MediaOutputBaseAdapter.this.mContext.getString(17039963), 0));
                textView.animate().setDuration(200).translationY(-dimensionPixelSize).setInterpolator(Interpolators.FAST_OUT_SLOW_IN).setListener(new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animator) {
                        view2.requireViewById(R$id.volume_indeterminate_progress).setVisibility(0);
                    }
                });
                seekBar.animate().alpha(0.0f).setDuration(200).setListener(new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animator) {
                        TextView textView = (TextView) view.requireViewById(R$id.two_line_title);
                        textView.setTypeface(Typeface.create(MediaOutputBaseAdapter.this.mContext.getString(17039962), 0));
                        textView.animate().setDuration(200).translationY(dimensionPixelSize).setInterpolator(Interpolators.FAST_OUT_SLOW_IN).setListener(new AnimatorListenerAdapter() {
                            public void onAnimationEnd(Animator animator) {
                                boolean unused = MediaOutputBaseAdapter.this.mIsAnimating = false;
        ...
        private void disableSeekBar() {
            ...
            this.mSeekBar.setOnTouchListener(C1042x9ea0900.INSTANCE);
        }
    }
}
