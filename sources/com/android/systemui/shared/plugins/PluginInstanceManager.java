...
public class PluginInstanceManager<T extends Plugin> {
    ...
    private class PluginHandler extends Handler {
        ...
        /* JADX WARNING: Missing exception handler attribute for start block: B:29:0x011f */
        /* JADX WARNING: Removed duplicated region for block: B:33:0x0127 A[SYNTHETIC, Splitter:B:33:0x0127] */
        /* JADX WARNING: Removed duplicated region for block: B:35:0x0158 A[Catch:{ all -> 0x0203 }] */
        ...
        public com.android.systemui.shared.plugins.PluginInstanceManager.PluginInfo<T> handleLoadPlugin(android.content.ComponentName r19) {
            ...
            L_0x003f:
                ...
                com.android.systemui.shared.plugins.PluginInstanceManager r0 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ all -> 0x0203 }
                android.content.pm.PackageManager r0 = r0.mPm     // Catch:{ all -> 0x0203 }
                r14 = 0
                android.content.pm.ApplicationInfo r0 = r0.getApplicationInfo(r12, r14)     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginInstanceManager r6 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ all -> 0x0203 }
                android.content.pm.PackageManager r6 = r6.mPm     // Catch:{ all -> 0x0203 }
                java.lang.String r7 = "com.android.systemui.permission.PLUGIN"
                int r6 = r6.checkPermission(r7, r12)     // Catch:{ all -> 0x0203 }
                ...
                android.util.Log.d(r4, r0)     // Catch:{ all -> 0x0203 }
                return r5
            L_0x0075:
                com.android.systemui.shared.plugins.PluginInstanceManager r6 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginManagerImpl r6 = r6.mManager     // Catch:{ all -> 0x0203 }
                java.lang.ClassLoader r6 = r6.getClassLoader(r0)     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginInstanceManager$PluginContextWrapper r10 = new com.android.systemui.shared.plugins.PluginInstanceManager$PluginContextWrapper     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginInstanceManager r7 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ all -> 0x0203 }
                android.content.Context r7 = r7.mContext     // Catch:{ all -> 0x0203 }
                android.content.Context r0 = r7.createApplicationContext(r0, r14)     // Catch:{ all -> 0x0203 }
                r10.<init>(r0, r6)     // Catch:{ all -> 0x0203 }
                r15 = 1
                java.lang.Class r0 = java.lang.Class.forName(r13, r15, r6)     // Catch:{ all -> 0x0203 }
                java.lang.Object r6 = r0.newInstance()     // Catch:{ all -> 0x0203 }
                r11 = r6
                com.android.systemui.plugins.Plugin r11 = (com.android.systemui.plugins.Plugin) r11     // Catch:{ all -> 0x0203 }
            ...
            L_0x00b4:
                ...
                r17 = r11
            L_0x00b7:
                android.content.res.Resources r6 = android.content.res.Resources.getSystem()     // Catch:{ all -> 0x0203 }
                java.lang.String r7 = "stat_sys_warning"
                java.lang.String r8 = "drawable"
                int r6 = r6.getIdentifier(r7, r8, r3)     // Catch:{ all -> 0x0203 }
                android.content.res.Resources r7 = android.content.res.Resources.getSystem()     // Catch:{ all -> 0x0203 }
                java.lang.String r8 = "system_notification_accent_color"
                java.lang.String r9 = "color"
                int r3 = r7.getIdentifier(r8, r9, r3)     // Catch:{ all -> 0x0203 }
                android.app.Notification$Builder r7 = new android.app.Notification$Builder     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginInstanceManager r8 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ all -> 0x0203 }
                android.content.Context r8 = r8.mContext     // Catch:{ all -> 0x0203 }
                java.lang.String r9 = "ALR"
                r7.<init>(r8, r9)     // Catch:{ all -> 0x0203 }
                android.app.Notification$BigTextStyle r8 = new android.app.Notification$BigTextStyle     // Catch:{ all -> 0x0203 }
                r8.<init>()     // Catch:{ all -> 0x0203 }
                android.app.Notification$Builder r7 = r7.setStyle(r8)     // Catch:{ all -> 0x0203 }
                android.app.Notification$Builder r6 = r7.setSmallIcon(r6)     // Catch:{ all -> 0x0203 }
                r7 = 0
                android.app.Notification$Builder r6 = r6.setWhen(r7)     // Catch:{ all -> 0x0203 }
                android.app.Notification$Builder r6 = r6.setShowWhen(r14)     // Catch:{ all -> 0x0203 }
                android.app.Notification$Builder r6 = r6.setVisibility(r15)     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginInstanceManager r7 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ all -> 0x0203 }
                android.content.Context r7 = r7.mContext     // Catch:{ all -> 0x0203 }
                int r3 = r7.getColor(r3)     // Catch:{ all -> 0x0203 }
                android.app.Notification$Builder r3 = r6.setColor(r3)     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginInstanceManager r6 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ NameNotFoundException -> 0x011f }
                android.content.pm.PackageManager r6 = r6.mPm     // Catch:{ NameNotFoundException -> 0x011f }
                android.content.pm.ServiceInfo r6 = r6.getServiceInfo(r2, r14)     // Catch:{ NameNotFoundException -> 0x011f }
                com.android.systemui.shared.plugins.PluginInstanceManager r7 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ NameNotFoundException -> 0x011f }
                android.content.pm.PackageManager r7 = r7.mPm     // Catch:{ NameNotFoundException -> 0x011f }
                java.lang.CharSequence r6 = r6.loadLabel(r7)     // Catch:{ NameNotFoundException -> 0x011f }
                java.lang.String r13 = r6.toString()     // Catch:{ NameNotFoundException -> 0x011f }
            L_0x011f:
                boolean r6 = r0.isTooNew()     // Catch:{ all -> 0x0203 }
                java.lang.String r7 = "Plugin \""
                if (r6 != 0) goto L_0x0158
                java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x0203 }
                r6.<init>()     // Catch:{ all -> 0x0203 }
                r6.append(r7)     // Catch:{ all -> 0x0203 }
                r6.append(r13)     // Catch:{ all -> 0x0203 }
                java.lang.String r7 = "\" is too old"
                r6.append(r7)     // Catch:{ all -> 0x0203 }
                java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0203 }
                android.app.Notification$Builder r6 = r3.setContentTitle(r6)     // Catch:{ all -> 0x0203 }
                ...
                r7.append(r8)     // Catch:{ all -> 0x0203 }
                java.lang.String r0 = r0.getMessage()     // Catch:{ all -> 0x0203 }
                r7.append(r0)     // Catch:{ all -> 0x0203 }
                java.lang.String r0 = r7.toString()     // Catch:{ all -> 0x0203 }
                r6.setContentText(r0)     // Catch:{ all -> 0x0203 }
                goto L_0x0188
            L_0x0158:
                java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x0203 }
                r6.<init>()     // Catch:{ all -> 0x0203 }
                ...
                r6.setContentText(r0)     // Catch:{ all -> 0x0203 }
            L_0x0188:
                android.content.Intent r0 = new android.content.Intent     // Catch:{ all -> 0x0203 }
                java.lang.String r6 = "com.android.systemui.action.DISABLE_PLUGIN"
                r0.<init>(r6)     // Catch:{ all -> 0x0203 }
                java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x0203 }
                r6.<init>()     // Catch:{ all -> 0x0203 }
                java.lang.String r7 = "package://"
                r6.append(r7)     // Catch:{ all -> 0x0203 }
                java.lang.String r2 = r19.flattenToString()     // Catch:{ all -> 0x0203 }
                r6.append(r2)     // Catch:{ all -> 0x0203 }
                java.lang.String r2 = r6.toString()     // Catch:{ all -> 0x0203 }
                android.net.Uri r2 = android.net.Uri.parse(r2)     // Catch:{ all -> 0x0203 }
                android.content.Intent r0 = r0.setData(r2)     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginInstanceManager r2 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ all -> 0x0203 }
                android.content.Context r2 = r2.mContext     // Catch:{ all -> 0x0203 }
                r6 = 67108864(0x4000000, float:1.5046328E-36)
                android.app.PendingIntent r0 = android.app.PendingIntent.getBroadcast(r2, r14, r0, r6)     // Catch:{ all -> 0x0203 }
                android.app.Notification$Action$Builder r2 = new android.app.Notification$Action$Builder     // Catch:{ all -> 0x0203 }
                java.lang.String r6 = "Disable plugin"
                r2.<init>(r5, r6, r0)     // Catch:{ all -> 0x0203 }
                android.app.Notification$Action r0 = r2.build()     // Catch:{ all -> 0x0203 }
                r3.addAction(r0)     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginInstanceManager r0 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ all -> 0x0203 }
                android.content.Context r0 = r0.mContext     // Catch:{ all -> 0x0203 }
                java.lang.Class<android.app.NotificationManager> r2 = android.app.NotificationManager.class
                java.lang.Object r0 = r0.getSystemService(r2)     // Catch:{ all -> 0x0203 }
                android.app.NotificationManager r0 = (android.app.NotificationManager) r0     // Catch:{ all -> 0x0203 }
                r2 = 6
                android.app.Notification r3 = r3.build()     // Catch:{ all -> 0x0203 }
                r0.notify(r2, r3)     // Catch:{ all -> 0x0203 }
                java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x0203 }
                r0.<init>()     // Catch:{ all -> 0x0203 }
                java.lang.String r2 = "Plugin has invalid interface version "
                r0.append(r2)     // Catch:{ all -> 0x0203 }
                int r2 = r17.getVersion()     // Catch:{ all -> 0x0203 }
                r0.append(r2)     // Catch:{ all -> 0x0203 }
                java.lang.String r2 = ", expected "
                r0.append(r2)     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.PluginInstanceManager r1 = com.android.systemui.shared.plugins.PluginInstanceManager.this     // Catch:{ all -> 0x0203 }
                com.android.systemui.shared.plugins.VersionInfo r1 = r1.mVersion     // Catch:{ all -> 0x0203 }
                r0.append(r1)     // Catch:{ all -> 0x0203 }
                java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x0203 }
                android.util.Log.w(r4, r0)     // Catch:{ all -> 0x0203 }
                return r5
            L_0x0203:
                r0 = move-exception
