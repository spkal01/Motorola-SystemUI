...
public class MLand extends FrameLayout {
    ...
    /* renamed from: dp */
    private static float f89dp = 1.0f;
    ...
    /* renamed from: L */
    public static void m33L(String str, Object... objArr) {
        if (DEBUG) {
            if (objArr.length != 0) {
    ...
    private static class Params {
        ...
        public Params(Resources resources) {
            ...
            this.f93G = resources.getDimensionPixelSize(R$dimen.f67G);
            ...
            if (this.OBSTACLE_MIN <= this.OBSTACLE_WIDTH / 2) {
                MLand.m33L("error: obstacles might be too short, adjusting", new Object[0]);
    ...
    public MLand(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mPlayerTracePaint.setStrokeWidth(f89dp * 2.0f);
    ...
    public void onAttachedToWindow() {
        ...
        f89dp = getResources().getDisplayMetrics().density;
        reset();
        start(false);
    }
    ...
    public void reset() {
        ...
        for (int i6 = 0; i6 < 20; i6++) {
            ...
            if (frand2 < 0.3d && this.mTimeOfDay != 0) {
                ...
                scenery.f101z = f4;
                scenery.f99v = f4 * 0.85f;
                if (this.mScene == 0) {
                    scenery.setBackgroundColor(-7829368);
                    scenery.f98h = irand(PARAMS.BUILDING_HEIGHT_MIN, i5);
                }
                int i8 = (int) (scenery.f101z * 255.0f);
            ...
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(scenery.f100w, scenery.f98h);
    ...
    public void start(boolean z) {
        ...
        m33L("start(startPlaying=%s)", objArr);
    ...
    public void step(long j, long j2) {
        ...
        while (i < childCount) {
            ...
            if (childAt instanceof GameView) {
                ((GameView) childAt).step(j, j2, this.f91t, this.f90dt);
            }
            i2 = i + 1;
        }
        if (this.mPlaying) {
                ...
                if (player.mAlive) {
                    if (player.below(this.mHeight)) {
                        if (DEBUG_IDDQD) {
                            ...
                            m33L("player %d hit the floor", Integer.valueOf(i));
                            thump(i, 80);
                            player.die();
                        }
                    }
                    ...
                    while (true) {
                        ...
                        if (obstacle.intersects(player) && !DEBUG_IDDQD) {
                            m33L("player hit an obstacle", new Object[0]);
                            thump(i, 80);
                            player.die();
                        } else if (obstacle.cleared(player) && (obstacle instanceof Stem)) {
                            i4 = Math.max(i4, ((Stem) obstacle).f102id);
                        }
                        size = i5;
                    }
                    if (i4 > player.mScore) {
        ...
        while (true) {
            ...
            } else if ((childAt2 instanceof Scenery) && childAt2.getTranslationX() + ((float) ((Scenery) childAt2).f100w) < 0.0f) {
        ...
        if (this.mPlaying) {
            ...
            if (f3 - this.mLastPipeTime > ((float) PARAMS.OBSTACLE_PERIOD)) {
                ...
                addView(stem, new FrameLayout.LayoutParams(PARAMS.OBSTACLE_STEM_WIDTH, (int) stem.f92h, 51));
                stem.setTranslationX((float) (this.mWidth + i12));
                float f4 = (float) i13;
                stem.setTranslationY((-stem.f92h) - f4);
                ...
                pop.setScaleX(0.25f);
                pop.setScaleY(-0.25f);
                pop.animate().translationY(stem.f92h - ((float) i12)).scaleX(1.0f).scaleY(-1.0f).setStartDelay(j3).setDuration(250);
                ...
                addView(stem2, new FrameLayout.LayoutParams(PARAMS.OBSTACLE_STEM_WIDTH, (int) stem2.f92h, 51));
                ...
                long j4 = (long) irand2;
                stem2.animate().translationY(((float) this.mHeight) - stem2.f92h).setStartDelay(j4).setDuration(400);
                ...
                pop2.animate().translationY((((float) this.mHeight) - stem2.f92h) - f4).scaleX(1.0f).scaleY(1.0f).setStartDelay(j4).setDuration(400);
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        m33L("keyDown: %d", Integer.valueOf(i));
    ...
    private void unpoke(int i) {
        Player player;
        m33L("unboost(%d)", Integer.valueOf(i));
    ...
    private static class Player extends ImageView implements GameView {
        ...
        public Player(Context context) {
            ...
            setBackgroundResource(R$drawable.f204android);
        ...
        public void step(long j, long j2, float f, float f2) {
            ...
            if (this.mBoosting) {
                this.f94dv = (float) (-MLand.PARAMS.BOOST_DV);
            } else {
                this.f94dv += (float) MLand.PARAMS.f93G;
            }
            if (this.f94dv < ((float) (-MLand.PARAMS.MAX_V))) {
                this.f94dv = (float) (-MLand.PARAMS.MAX_V);
            } else if (this.f94dv > ((float) MLand.PARAMS.MAX_V)) {
                this.f94dv = (float) MLand.PARAMS.MAX_V;
            }
            float translationY = getTranslationY() + (this.f94dv * f2);
            if (translationY < 0.0f) {
                translationY = 0.0f;
            }
            setTranslationY(translationY);
            setRotation(MLand.lerp(MLand.clamp(MLand.rlerp(this.f94dv, (float) MLand.PARAMS.MAX_V, (float) (MLand.PARAMS.MAX_V * -1))), 90.0f, -90.0f) + 90.0f);
    ...
    private class Pop extends Obstacle {
        ...
        public boolean intersects(Player player) {
            ...
            for (int i = 0; i < length; i++) {
                float[] fArr = player.corners;
                int i2 = i * 2;
                if (Math.hypot((double) (((int) fArr[i2]) - this.f95cx), (double) (((int) fArr[i2 + 1]) - this.f96cy)) <= ((double) this.f97r)) {
                    return true;
                }
            }
            return false;
        ...
        public void step(long j, long j2, float f, float f2) {
            ...
            this.f95cx = (rect.left + rect.right) / 2;
            this.f96cy = (rect.top + rect.bottom) / 2;
            this.f97r = getWidth() / 3;
        }
    ...
    private class Stem extends Obstacle {
        ...
        public Stem(Context context, float f, boolean z) {
            super(context, f);
            this.f102id = MLand.this.mCurrentPipeId;
            this.mDrawShadow = z;
    ...
    private class Scenery extends FrameLayout implements GameView {
        ...
        public void step(long j, long j2, float f, float f2) {
            setTranslationX(getTranslationX() - ((MLand.PARAMS.TRANSLATION_PER_SEC * f2) * this.f99v));
        }
    }
    ...
    private class Building extends Scenery {
        public Building(Context context) {
            super(context);
            this.f100w = MLand.irand(MLand.PARAMS.BUILDING_WIDTH_MIN, MLand.PARAMS.BUILDING_WIDTH_MAX);
            this.f98h = 0;
        }
    }
    ...
    private class Cloud extends Scenery {
        public Cloud(Context context) {
            ...
            this.f100w = irand;
            this.f101z = 0.0f;
            this.f99v = MLand.frand(0.15f, 0.5f);
        }
    }
