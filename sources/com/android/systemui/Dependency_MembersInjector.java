...
public final class Dependency_MembersInjector {
    ...
    public static void injectMCliStatusBarWindowController(Dependency dependency, Lazy<CliStatusBarWindowController> lazy) {
        dependency.mCliStatusBarWindowController = lazy;
    }
    ...
    public static void injectMCliNotificationStackClient(Dependency dependency, Lazy<CliNotificationStackClient> lazy) {
        dependency.mCliNotificationStackClient = lazy;
    }
    ...
    public static void injectMCliStatusBar(Dependency dependency, Lazy<CliStatusBar> lazy) {
        dependency.mCliStatusBar = lazy;
    }
    ...
    public static void injectMRROsController(Dependency dependency, Lazy<RROsController> lazy) {
        dependency.mRROsController = lazy;
    }

    public static void injectMMotoDisplayManager(Dependency dependency, Lazy<MotoDisplayManager> lazy) {
        dependency.mMotoDisplayManager = lazy;
    }

    public static void injectMDualSimIconController(Dependency dependency, Lazy<DualSimIconController> lazy) {
        dependency.mDualSimIconController = lazy;
    }

    public static void injectMMotoTaskBarController(Dependency dependency, Lazy<MotoTaskBarController> lazy) {
        dependency.mMotoTaskBarController = lazy;
    }

    public static void injectMCellLocationController(Dependency dependency, Lazy<CellLocationController> lazy) {
        dependency.mCellLocationController = lazy;
    }

    public static void injectMMediaCarouselController(Dependency dependency, Lazy<MediaCarouselController> lazy) {
        dependency.mMediaCarouselController = lazy;
    }

    public static void injectMCliNavGestureController(Dependency dependency, Lazy<CliNavGestureController> lazy) {
        dependency.mCliNavGestureController = lazy;
    }

    public static void injectMMultiUserCliNavGestures(Dependency dependency, Lazy<MultiUserCliNavGestures> lazy) {
        dependency.mMultiUserCliNavGestures = lazy;
    }

    public static void injectMTooltipPopupManager(Dependency dependency, Lazy<TooltipPopupManager> lazy) {
        dependency.mTooltipPopupManager = lazy;
    }

    public static void injectMDesktopTileServices(Dependency dependency, Lazy<MotoDesktopProcessTileServices> lazy) {
        dependency.mDesktopTileServices = lazy;
    }

    public static void injectMDesktopDisplayRootModulesManager(Dependency dependency, Lazy<DesktopDisplayRootModulesManager> lazy) {
        dependency.mDesktopDisplayRootModulesManager = lazy;
    }

    public static void injectMQSTileHost(Dependency dependency, Lazy<QSTileHost> lazy) {
        dependency.mQSTileHost = lazy;
    }
}
