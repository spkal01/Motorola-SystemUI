...
public class PageIndicator extends ViewGroup {
    ...
    public PageIndicator(Context context, AttributeSet attributeSet) {
        ...
        if (MotoFeature.isCliContext(context)) {
            this.mPageIndicatorWidth = resources.getDimensionPixelSize(R$dimen.cli_qs_page_indicator_width);
            this.mPageIndicatorHeight = resources.getDimensionPixelSize(R$dimen.cli_qs_page_indicator_height);
        }
