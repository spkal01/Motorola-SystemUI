...
/* renamed from: com.android.systemui.qs.QSPrcFixedPanelController_Factory */
public final class QSPrcFixedPanelController_Factory implements Factory<QSPrcFixedPanelController> {
    ...
    private final Provider<QSPrcFixedPanel> viewProvider;

    public QSPrcFixedPanelController_Factory(Provider<QSPrcFixedPanel> provider, Provider<QSTileHost> provider2, Provider<QSCustomizerController> provider3, Provider<Boolean> provider4, Provider<MediaHost> provider5, Provider<MetricsLogger> provider6, Provider<UiEventLogger> provider7, Provider<QSLogger> provider8, Provider<DumpManager> provider9, Provider<FeatureFlags> provider10) {
    ...
    public QSPrcFixedPanelController get() {
    ...
    public static QSPrcFixedPanelController_Factory create(Provider<QSPrcFixedPanel> provider, Provider<QSTileHost> provider2, Provider<QSCustomizerController> provider3, Provider<Boolean> provider4, Provider<MediaHost> provider5, Provider<MetricsLogger> provider6, Provider<UiEventLogger> provider7, Provider<QSLogger> provider8, Provider<DumpManager> provider9, Provider<FeatureFlags> provider10) {
        return new QSPrcFixedPanelController_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10);
    }

    public static QSPrcFixedPanelController newInstance(QSPrcFixedPanel qSPrcFixedPanel, QSTileHost qSTileHost, QSCustomizerController qSCustomizerController, boolean z, MediaHost mediaHost, MetricsLogger metricsLogger, UiEventLogger uiEventLogger, QSLogger qSLogger, DumpManager dumpManager, FeatureFlags featureFlags) {
        return new QSPrcFixedPanelController(qSPrcFixedPanel, qSTileHost, qSCustomizerController, z, mediaHost, metricsLogger, uiEventLogger, qSLogger, dumpManager, featureFlags);
    }
}
