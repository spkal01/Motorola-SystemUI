...
public class InternetTile extends QSTileImpl<QSTile.SignalState> {
    ...
    protected final class InternetSignalCallback implements NetworkController.SignalCallback {
        ...
        public void setWifiIndicators(NetworkController.WifiIndicators wifiIndicators) {
            if (QSTileImpl.DEBUG) {
                ...
                Log.d(access$400, "setWifiIndicators: " + wifiIndicators);
            }
        ...
        private boolean isWifiConnected() {
            WifiCallbackInfo wifiCallbackInfo = this.mWifiInfo;
            return wifiCallbackInfo.mEnabled && wifiCallbackInfo.mWifiSignalIconId > 0 && wifiCallbackInfo.mSsid != null;
        }
        ...
        public void setMobileDataIndicators(NetworkController.MobileDataIndicators mobileDataIndicators) {
            ...
            if (mobileDataIndicators.qsIcon != null) {
                ...
                if (extendedMobileDataInfo != null) {
                    this.mCellularInfo.mShowSeparatedSignalBars = extendedMobileDataInfo.showSeparatedSignalBars;
                } else {
                    this.mCellularInfo.mShowSeparatedSignalBars = false;
                }
        ...
        public void setEthernetIndicators(NetworkController.IconState iconState) {
            String str;
            if (QSTileImpl.DEBUG) {
                String access$900 = InternetTile.this.TAG;
        ...
        public void setNoSims(boolean z, boolean z2) {
            if (QSTileImpl.DEBUG) {
                ...
                Log.d(access$1200, "setNoSims: show = " + z + ",simDetected = " + z2);
            }
            CellularCallbackInfo cellularCallbackInfo = this.mCellularInfo;
        ...
        public void setIsAirplaneMode(NetworkController.IconState iconState) {
            String str;
            if (QSTileImpl.DEBUG) {
                String access$1400 = InternetTile.this.TAG;
                StringBuilder sb = new StringBuilder();
            ...
            if (z != z2) {
                ...
                this.mWifiInfo.mAirplaneModeEnabled = z2;
                refreshConnectivityState();
            }
        }
        ...
        private void refreshConnectivityState() {
            if (this.mEthernetInfo.mConnected) {
                return;
            }
            if (isWifiConnected()) {
    ...
    private void handleUpdateCellularState(QSTile.SignalState signalState, Object obj) {
        ...
        if (cellularCallbackInfo.mAirplaneModeEnabled && cellularCallbackInfo.mQsTypeIcon != TelephonyIcons.ICON_CWF) {
            ...
            int i = cellularCallbackInfo.mMobileSignalIconId;
            if (i > 0) {
                if (cellularCallbackInfo.mShowSeparatedSignalBars) {
                    signalState.icon = QSTileImpl.ResourceIcon.get(i);
                } else {
                    signalState.icon = new SignalIcon(i);
                }
