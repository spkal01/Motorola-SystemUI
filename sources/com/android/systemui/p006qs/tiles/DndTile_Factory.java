...
public final class DndTile_Factory implements Factory<DndTile> {
    ...
    public DndTile get() {
        return newInstance(this.hostProvider.get(), this.backgroundLooperProvider.get(), this.mainHandlerProvider.get(), this.falsingManagerProvider.get(), this.metricsLoggerProvider.get(), this.statusBarStateControllerProvider.get(), this.activityStarterProvider.get(), this.qsLoggerProvider.get(), this.zenModeControllerProvider.get(), this.sharedPreferencesProvider.get());
    }
