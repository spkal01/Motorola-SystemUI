...
public class PathInterpolatorBuilder {
    ...
    /* renamed from: mX */
    private float[] f113mX;

    /* renamed from: mY */
    private float[] f114mY;
    ...
    private void initPath(Path path) {
        ...
        if (approximate[1] == 0.0f && approximate[2] == 0.0f && approximate[approximate.length - 2] == 1.0f && approximate[approximate.length - 1] == 1.0f) {
            this.f113mX = new float[length];
            this.f114mY = new float[length];
            ...
            while (i < length) {
                ...
                if (f3 == f && f4 != f2) {
                    ...
                    float[] fArr = this.f113mX;
                    fArr[i] = f4;
                    float[] fArr2 = this.f114mY;
                    fArr2[i] = f5;
                    if (i > 0) {
                        int i6 = i - 1;
    ...
    public Interpolator getXInterpolator() {
        return new PathInterpolator(this.mDist, this.f113mX);
    }

    public Interpolator getYInterpolator() {
        return new PathInterpolator(this.mDist, this.f114mY);
    }
    ...
    private static class PathInterpolator extends BaseInterpolator {
        ...
        /* renamed from: mX */
        private final float[] f115mX;

        /* renamed from: mY */
        private final float[] f116mY;
        ...
        public float getInterpolation(float f) {
            ...
            int i = 0;
            int length = this.f115mX.length - 1;
            while (length - i > 1) {
                int i2 = (i + length) / 2;
                if (f < this.f115mX[i2]) {
                    length = i2;
            ...
            float[] fArr = this.f115mX;
            float f2 = fArr[length] - fArr[i];
            if (f2 == 0.0f) {
                return this.f116mY[i];
            }
            float[] fArr2 = this.f116mY;
            float f3 = fArr2[i];
