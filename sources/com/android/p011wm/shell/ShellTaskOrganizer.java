...
public class ShellTaskOrganizer extends TaskOrganizer implements SizeCompatUIController.SizeCompatUICallback {
    ...
    public ShellTaskOrganizer(ShellExecutor shellExecutor, Context context, SizeCompatUIController sizeCompatUIController) {
        this((ITaskOrganizerController) null, shellExecutor, context, sizeCompatUIController);
    }
    ...
    public List<TaskAppearedInfo> registerOrganizer() {
        ...
        synchronized (this.mLock) {
            if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 580605218, 0, (String) null, (Object[]) null);
            }
            ...
            for (int i = 0; i < registerOrganizer.size(); i++) {
                ...
                if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                    ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -1683614271, 1, (String) null, Long.valueOf((long) taskAppearedInfo.getTaskInfo().taskId), String.valueOf(taskAppearedInfo.getTaskInfo().baseIntent));
                }
    ...
    public void createRootTask(int i, int i2, TaskListener taskListener) {
        if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
            ...
            ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -1312360667, 5, (String) null, Long.valueOf((long) i), Long.valueOf((long) i2), valueOf);
        }
    ...
    public void addListenerForType(TaskListener taskListener, @TaskListenerType int... iArr) {
        synchronized (this.mLock) {
            int i = 0;
            if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 1990759023, 0, (String) null, String.valueOf(Arrays.toString(iArr)), String.valueOf(taskListener));
            }
    ...
    public void removeListener(TaskListener taskListener) {
        synchronized (this.mLock) {
            if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -1340279385, 0, (String) null, String.valueOf(taskListener));
            }
    ...
    private void onTaskAppeared(TaskAppearedInfo taskAppearedInfo) {
        ...
        if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
            ...
            ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -1325223370, 1, (String) null, Long.valueOf(j), valueOf);
        }
    ...
    public void onTaskInfoChanged(ActivityManager.RunningTaskInfo runningTaskInfo) {
        synchronized (this.mLock) {
            if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 157713005, 1, (String) null, Long.valueOf((long) runningTaskInfo.taskId));
            }
    ...
    public void onBackPressedOnTaskRoot(ActivityManager.RunningTaskInfo runningTaskInfo) {
        synchronized (this.mLock) {
            if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 980952660, 1, (String) null, Long.valueOf((long) runningTaskInfo.taskId));
            }
    ...
    public void onTaskVanished(ActivityManager.RunningTaskInfo runningTaskInfo) {
        synchronized (this.mLock) {
            if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                ...
                ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -880817403, 1, (String) null, Long.valueOf(j));
            }
            ...
            notifyLocusVisibilityIfNeeded(runningTaskInfo);
            notifySizeCompatUI(runningTaskInfo, (TaskListener) null);
        }
    }
    ...
    private void notifySizeCompatUI(ActivityManager.RunningTaskInfo runningTaskInfo, TaskListener taskListener) {
        if (this.mSizeCompatUI != null) {
            if (taskListener == null || !taskListener.supportSizeCompatUI() || !runningTaskInfo.topActivityInSizeCompat || !runningTaskInfo.isVisible) {
                this.mSizeCompatUI.onSizeCompatInfoChanged(runningTaskInfo.displayId, runningTaskInfo.taskId, (Configuration) null, (TaskListener) null);
            } else {
