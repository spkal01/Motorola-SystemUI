...
public class DisplayController {
    ...
    private class DisplayWindowListenerImpl extends IDisplayWindowListener.Stub {
        ...
        public void onDisplayAdded(int i) {
            DisplayController.this.mMainExecutor.execute(new C2285xd1ef1ecf(this, i));
        }
        ...
        public void onDisplayConfigurationChanged(int i, Configuration configuration) {
            DisplayController.this.mMainExecutor.execute(new C2289xd1ef1ed3(this, i, configuration));
        }
        ...
        public void onDisplayRemoved(int i) {
            DisplayController.this.mMainExecutor.execute(new C2286xd1ef1ed0(this, i));
        }
        ...
        public void onFixedRotationStarted(int i, int i2) {
            DisplayController.this.mMainExecutor.execute(new C2288xd1ef1ed2(this, i, i2));
        }
        ...
        public void onFixedRotationFinished(int i) {
            DisplayController.this.mMainExecutor.execute(new C2287xd1ef1ed1(this, i));
        }
