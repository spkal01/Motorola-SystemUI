...
public final class SplitLayout {
    ...
    public SplitLayout(String str, Context context, Configuration configuration, SplitLayoutHandler splitLayoutHandler, SplitWindowManager.ParentContainerCallbacks parentContainerCallbacks, DisplayImeController displayImeController, ShellTaskOrganizer shellTaskOrganizer) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(17105206);
        this.mDividerWindowWidth = dimensionPixelSize;
        int dimensionPixelSize2 = resources.getDimensionPixelSize(17105205);
    ...
    public void applySurfaceChanges(SurfaceControl.Transaction transaction, SurfaceControl surfaceControl, SurfaceControl surfaceControl2, SurfaceControl surfaceControl3, SurfaceControl surfaceControl4) {
        Rect access$200 = this.mImePositionProcessor.adjustForIme(this.mDividerBounds);
        Rect access$2002 = this.mImePositionProcessor.adjustForIme(this.mBounds1);
        Rect access$2003 = this.mImePositionProcessor.adjustForIme(this.mBounds2);
        SurfaceControl dividerLeash = getDividerLeash();
        if (dividerLeash != null) {
            transaction.setPosition(dividerLeash, (float) access$200.left, (float) access$200.top).setLayer(dividerLeash, Integer.MAX_VALUE);
        }
        transaction.setPosition(surfaceControl, (float) access$2002.left, (float) access$2002.top).setWindowCrop(surfaceControl, access$2002.width(), access$2002.height());
        transaction.setPosition(surfaceControl2, (float) access$2003.left, (float) access$2003.top).setWindowCrop(surfaceControl2, access$2003.width(), access$2003.height());
    ...
    private class ImePositionProcessor implements DisplayImeController.ImePositionProcessor {
        ...
        public int onImeStartPositioning(int i, int i2, int i3, boolean z, boolean z2, SurfaceControl.Transaction transaction) {
            ...
            SplitWindowManager access$700 = SplitLayout.this.mSplitWindowManager;
            if (!z || imeTargetPosition == -1) {
                z3 = true;
            }
            access$700.setInteractive(z3);
            return i4;
        }
