...
/* renamed from: com.android.wm.shell.sizecompatui.SizeCompatUILayout */
class SizeCompatUILayout {
    ...
    SizeCompatUILayout(SyncTransactionQueue syncTransactionQueue, SizeCompatUIController.SizeCompatUICallback sizeCompatUICallback, Context context, Configuration configuration, int i, ShellTaskOrganizer.TaskListener taskListener, DisplayLayout displayLayout, boolean z) {
        ...
        int dimensionPixelSize = this.mContext.getResources().getDimensionPixelSize(C2219R.dimen.size_compat_button_size);
    ...
    /* access modifiers changed from: package-private */
    @VisibleForTesting
    public SizeCompatUIWindowManager createHintWindowManager() {
    ...
    /* access modifiers changed from: package-private */
    public void updateHintSurfacePosition() {
    ...
    private void updateSurfacePosition(SurfaceControl surfaceControl, int i, int i2) {
        this.mSyncQueue.runInSync(new SizeCompatUILayout$$ExternalSyntheticLambda0(surfaceControl, i, i2));
    }
