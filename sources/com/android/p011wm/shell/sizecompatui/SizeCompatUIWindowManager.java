...
/* renamed from: com.android.wm.shell.sizecompatui.SizeCompatUIWindowManager */
class SizeCompatUIWindowManager extends WindowlessWindowManager {
    ...
    public SizeCompatRestartButton createSizeCompatButton() {
        if (this.mViewHost == null) {
            ...
            SizeCompatRestartButton sizeCompatRestartButton = (SizeCompatRestartButton) LayoutInflater.from(this.mContext).inflate(C2219R.layout.size_compat_ui, (ViewGroup) null);
    ...
    public SizeCompatHintPopup createSizeCompatHint() {
        if (this.mViewHost == null) {
            Context context = this.mContext;
            this.mViewHost = new SurfaceControlViewHost(context, context.getDisplay(), this);
            SizeCompatHintPopup sizeCompatHintPopup = (SizeCompatHintPopup) LayoutInflater.from(this.mContext).inflate(C2219R.layout.size_compat_mode_hint, (ViewGroup) null);
