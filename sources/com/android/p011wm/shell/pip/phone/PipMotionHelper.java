...
import com.android.p011wm.shell.animation.FloatProperties;
...
public class PipMotionHelper implements PipAppOpsListener.Callback, FloatingContentCoordinator.FloatingContent {
    ...
    private ThreadLocal<AnimationHandler> mSfAnimationHandlerThreadLocal = ThreadLocal.withInitial(new PipMotionHelper$$ExternalSyntheticLambda5(this));
    ...
    public /* synthetic */ AnimationHandler lambda$new$0() {
        ...
        return new AnimationHandler(new AnimationHandler.FrameCallbackScheduler() {
    ...
    public PipMotionHelper(Context context, PipBoundsState pipBoundsState, PipTaskOrganizer pipTaskOrganizer, PhonePipMenuController phonePipMenuController, PipSnapAlgorithm pipSnapAlgorithm, PipTransitionController pipTransitionController, FloatingContentCoordinator floatingContentCoordinator) {
        C23792 r0 = new PipTransitionController.PipTransitionCallback() {
    ...
    public void movePip(Rect rect, boolean z) {
        ...
        if (!this.mSpringingToTouch) {
            ...
            this.mPipTaskOrganizer.scheduleUserResizePip(getBounds(), rect, new PipMotionHelper$$ExternalSyntheticLambda4(this));
            return;
        }
    ...
    public void animateIntoDismissTarget(MagnetizedObject.MagneticTarget magneticTarget, float f, float f2, boolean z, Function0<Unit> function0) {
        ...
        float dimensionPixelSize = ((float) this.mContext.getResources().getDimensionPixelSize(C2219R.dimen.dismiss_circle_size)) * 0.85f;
    ...
    private void startBoundsAnimator(float f, float f2, Runnable runnable) {
        ...
        if (!this.mTemporaryBoundsPhysicsAnimator.isRunning()) {
            if (runnable != null) {
                this.mTemporaryBoundsPhysicsAnimator.addUpdateListener(this.mResizePipUpdateListener).withEndActions(new PipMotionHelper$$ExternalSyntheticLambda2(this), runnable);
            } else {
                this.mTemporaryBoundsPhysicsAnimator.addUpdateListener(this.mResizePipUpdateListener).withEndActions(new PipMotionHelper$$ExternalSyntheticLambda2(this));
            }
        }
        ...
        if (!this.mDismissalPending && !this.mSpringingToTouch && !this.mMagnetizedPip.getObjectStuckToTarget()) {
            ...
            if (!this.mDismissalPending) {
                if (Build.IS_DEBUGGABLE) {
                    Log.d("PipDebug", "onBoundsPhysicsAnimationEnd to " + getBounds());
                }
