...
public class PipTouchHandler {
    ...
    public PipTouchHandler(Context context, PhonePipMenuController phonePipMenuController, PipBoundsAlgorithm pipBoundsAlgorithm, PipBoundsState pipBoundsState, PipTaskOrganizer pipTaskOrganizer, PipMotionHelper pipMotionHelper, FloatingContentCoordinator floatingContentCoordinator, PipUiEventLogger pipUiEventLogger, ShellExecutor shellExecutor) {
        ...
        PipTouchHandler$$ExternalSyntheticLambda7 pipTouchHandler$$ExternalSyntheticLambda7 = new PipTouchHandler$$ExternalSyntheticLambda7(this);
        PipTouchHandler$$ExternalSyntheticLambda7 pipTouchHandler$$ExternalSyntheticLambda72 = pipTouchHandler$$ExternalSyntheticLambda7;
        PipResizeGestureHandler pipResizeGestureHandler = r1;
        PipResizeGestureHandler pipResizeGestureHandler2 = new PipResizeGestureHandler(context, pipBoundsAlgorithm, pipBoundsState, pipMotionHelper3, pipTaskOrganizer, pipDismissTargetHandler, pipTouchHandler$$ExternalSyntheticLambda72, new PipTouchHandler$$ExternalSyntheticLambda5(this), pipUiEventLogger2, phonePipMenuController, shellExecutor);
        ...
        this.mTouchState = new PipTouchState(viewConfiguration, pipTouchHandler$$ExternalSyntheticLambda4, new PipTouchHandler$$ExternalSyntheticLambda3(phonePipMenuController2), shellExecutor2);
        this.mConnection = new PipAccessibilityInteractionConnection(context, pipBoundsState, this.mMotionHelper, pipTaskOrganizer, pipBoundsAlgorithm.getSnapAlgorithm(), new PipTouchHandler$$ExternalSyntheticLambda2(this), new PipTouchHandler$$ExternalSyntheticLambda5(this), new PipTouchHandler$$ExternalSyntheticLambda6(this), shellExecutor);
    }
    ...
    public void init() {
        this.mEnableResize = this.mContext.getResources().getBoolean(C2219R.bool.config_pipEnableResizeForMenu);
        reloadResources();
        ...
        DeviceConfig.addOnPropertiesChangedListener("systemui", this.mMainExecutor, new PipTouchHandler$$ExternalSyntheticLambda1(this));
        this.mStashVelocityThreshold = DeviceConfig.getFloat("systemui", "pip_velocity_threshold", 18000.0f);
        DeviceConfig.addOnPropertiesChangedListener("systemui", this.mMainExecutor, new PipTouchHandler$$ExternalSyntheticLambda0(this));
    }
    ...
    private void reloadResources() {
        ...
        this.mBottomOffsetBufferPx = resources.getDimensionPixelSize(C2219R.dimen.pip_bottom_offset_buffer);
        this.mExpandedShortestEdgeSize = resources.getDimensionPixelSize(C2219R.dimen.pip_expanded_shortest_edge_size);
        this.mImeOffset = resources.getDimensionPixelSize(C2219R.dimen.pip_ime_offset);
        this.mMinimumSizePercent = resources.getFraction(C2219R.fraction.config_pipShortestEdgePercent, 1, 1);
    ...
    public boolean handleTouchEvent(android.view.InputEvent r12) {
        ...
        L_0x012f:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p011wm.shell.pip.phone.PipTouchHandler.handleTouchEvent(android.view.InputEvent):boolean");
    }
    ...
    private class DefaultPipTouchGesture extends PipTouchGesture {
        ...
        private boolean shouldStash(PointF pointF, Rect rect) {
            ...
            boolean z2 = rect.right > PipTouchHandler.this.mPipBoundsState.getDisplayBounds().right + width || rect.left < PipTouchHandler.this.mPipBoundsState.getDisplayBounds().left - width;
            if (z || z2) {
                return true;
            }
            return false;
