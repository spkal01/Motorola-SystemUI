...
import com.android.p011wm.shell.common.ScreenshotUtils;
...
public class PipTaskOrganizer implements ShellTaskOrganizer.TaskListener, DisplayController.OnDisplaysChangedListener {
    ...
    /* renamed from: com.android.wm.shell.pip.PipTaskOrganizer$State */
    private enum State {
        UNDEFINED(0),
        TASK_APPEARED(1),
        ENTRY_SCHEDULED(2),
    ...
    public PipTaskOrganizer(Context context, SyncTransactionQueue syncTransactionQueue, PipBoundsState pipBoundsState, PipBoundsAlgorithm pipBoundsAlgorithm, PipMenuController pipMenuController, PipAnimationController pipAnimationController, PipSurfaceTransactionHelper pipSurfaceTransactionHelper, PipTransitionController pipTransitionController, Optional<LegacySplitScreenController> optional, DisplayController displayController, PipUiEventLogger pipUiEventLogger, ShellTaskOrganizer shellTaskOrganizer, ShellExecutor shellExecutor) {
        ...
        this.mEnterAnimationDuration = context.getResources().getInteger(C2219R.integer.config_pipEnterAnimationDuration);
        this.mExitAnimationDuration = context.getResources().getInteger(C2219R.integer.config_pipExitAnimationDuration);
        this.mCrossFadeAnimationDuration = context.getResources().getInteger(C2219R.integer.config_pipCrossfadeAnimationDuration);
        ...
        shellExecutor.execute(new PipTaskOrganizer$$ExternalSyntheticLambda5(this));
    ...
    public void exitPip(int i) {
        ...
        this.mSyncTransactionQueue.runInSync(new PipTaskOrganizer$$ExternalSyntheticLambda1(this, displayBounds, i3, i));
    }
    ...
    private void applyWindowingModeChangeOnExit(WindowContainerTransaction windowContainerTransaction, int i) {
        ...
        this.mSplitScreenOptional.ifPresent(new PipTaskOrganizer$$ExternalSyntheticLambda9(this, i, windowContainerTransaction));
    }
    ...
    public void onTaskAppeared(ActivityManager.RunningTaskInfo runningTaskInfo, SurfaceControl surfaceControl) {
        ...
        if (!this.mInSwipePipToHomeTransition) {
            ...
            if (Build.IS_DEBUGGABLE) {
                Log.d("PipDebug", "onTaskAppeared for task" + this.mTaskInfo.taskId + " to " + entryDestinationBounds + " and current is " + bounds);
            }
    ...
    private void onTaskAppearedWithFixedRotation() {
        ...
        Rect bounds = this.mTaskInfo.configuration.windowConfiguration.getBounds();
        Rect validSourceHintRect = PipBoundsAlgorithm.getValidSourceHintRect(this.mPictureInPictureParams, bounds);
        Rect entryDestinationBounds = this.mPipBoundsAlgorithm.getEntryDestinationBounds();
        if (Build.IS_DEBUGGABLE) {
            Log.d("PipDebug", "onTaskAppearedWithFixedRotation for task" + this.mTaskInfo.taskId + " to " + entryDestinationBounds + " and current is " + bounds);
        }
        animateResizePip(bounds, entryDestinationBounds, validSourceHintRect, 2, this.mEnterAnimationDuration, 0.0f);
        this.mState = State.ENTERING_PIP;
    }
    ...
    public void enterPipWithAlphaAnimation(Rect rect, long j) {
        ...
        applyEnterPipSyncTransaction(rect, new PipTaskOrganizer$$ExternalSyntheticLambda7(this, rect, j), (SurfaceControl.Transaction) null);
    }
    ...
    private void onEndOfSwipePipToHomeTransition() {
        ...
        applyEnterPipSyncTransaction(bounds, new PipTaskOrganizer$$ExternalSyntheticLambda8(this, bounds, surfaceControl), transaction);
    ...
    private void applyEnterPipSyncTransaction(Rect rect, Runnable runnable, SurfaceControl.Transaction transaction) {
        ...
        this.mSyncTransactionQueue.queue(windowContainerTransaction);
        if (runnable != null) {
            this.mSyncTransactionQueue.runInSync(new PipTaskOrganizer$$ExternalSyntheticLambda3(runnable));
        }
    }
    ...
    public void onTaskInfoChanged(ActivityManager.RunningTaskInfo runningTaskInfo) {
        ...
        if (state == State.ENTERED_PIP || state == State.EXITING_PIP) {
            ...
            scheduleAnimateResizePip(adjustedDestinationBounds, this.mEnterAnimationDuration, (Consumer<Rect>) null);
            return;
        }
        String str2 = TAG;
    ...
    public void onFixedRotationFinished(int i) {
        if (this.mWaitForFixedRotation) {
            ...
            if (state == State.TASK_APPEARED) {
                ...
                applyEnterPipSyncTransaction(destinationBounds, new PipTaskOrganizer$$ExternalSyntheticLambda6(this, destinationBounds), this.mDeferredAnimEndTransaction);
            }
            clearWaitForFixedRotation();
        }
    }
    ...
    private PipAnimationController.PipTransitionAnimator<?> animateResizePip(Rect rect, Rect rect2, Rect rect3, int i, int i2, float f) {
        ...
        Rect rect6 = rect5;
        PipAnimationController.PipTransitionAnimator<?> animator = this.mPipAnimationController.getAnimator(this.mTaskInfo, this.mLeash, i3 == 6 ? this.mPipBoundsState.getBounds() : rect, rect, rect2, rect6, i, f, deltaRotation);
        animator.setTransitionDirection(i3).setPipAnimationCallback(this.mPipAnimationCallback).setPipTransactionHandler(this.mPipTransactionHandler).setDuration((long) i2);
        if (PipAnimationController.isInPipDirection(i)) {
            if (rect6 == null) {
