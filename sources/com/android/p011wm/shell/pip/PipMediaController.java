...
public class PipMediaController {
    ...
    private final MediaSessionManager.OnActiveSessionsChangedListener mSessionsChangedListener = new PipMediaController$$ExternalSyntheticLambda0(this);
    ...
    public PipMediaController(Context context, Handler handler) {
        C23541 r0 = new BroadcastReceiver() {
        ...
        this.mPauseAction = getDefaultRemoteAction(C2219R.string.pip_pause, C2219R.C2221drawable.pip_ic_pause_white, "com.android.wm.shell.pip.PAUSE");
        this.mPlayAction = getDefaultRemoteAction(C2219R.string.pip_play, C2219R.C2221drawable.pip_ic_play_arrow_white, "com.android.wm.shell.pip.PLAY");
        this.mNextAction = getDefaultRemoteAction(C2219R.string.pip_skip_to_next, C2219R.C2221drawable.pip_ic_skip_next_white, "com.android.wm.shell.pip.NEXT");
        this.mPrevAction = getDefaultRemoteAction(C2219R.string.pip_skip_to_prev, C2219R.C2221drawable.pip_ic_skip_previous_white, "com.android.wm.shell.pip.PREV");
