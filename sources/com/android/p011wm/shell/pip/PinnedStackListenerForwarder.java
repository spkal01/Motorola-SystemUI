...
public class PinnedStackListenerForwarder {
    ...
    private class PinnedTaskListenerImpl extends IPinnedTaskListener.Stub {
        ...
        public void onMovementBoundsChanged(boolean z) {
            PinnedStackListenerForwarder.this.mMainExecutor.execute(new C2348x2eacda59(this, z));
        }
        ...
        public void onImeVisibilityChanged(boolean z, int i) {
            PinnedStackListenerForwarder.this.mMainExecutor.execute(new C2349x2eacda5a(this, z, i));
        }
        ...
        public void onActionsChanged(ParceledListSlice<RemoteAction> parceledListSlice) {
            PinnedStackListenerForwarder.this.mMainExecutor.execute(new C2347x2eacda58(this, parceledListSlice));
        }
        ...
        public void onActivityHidden(ComponentName componentName) {
            PinnedStackListenerForwarder.this.mMainExecutor.execute(new C2346x2eacda57(this, componentName));
        }
        ...
        public void onAspectRatioChanged(float f) {
            PinnedStackListenerForwarder.this.mMainExecutor.execute(new C2345x2eacda56(this, f));
        }
