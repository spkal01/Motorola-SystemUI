...
public class PipBoundsAlgorithm {
    ...
    private void reloadResources(Context context) {
        ...
        this.mDefaultAspectRatio = resources.getFloat(17105095);
        this.mDefaultStackGravity = resources.getInteger(17694789);
        this.mDefaultMinSize = resources.getDimensionPixelSize(17105186);
        this.mOverridableMinSize = resources.getDimensionPixelSize(17105442);
        ...
        this.mDefaultSizePercent = resources.getFloat(17105096);
        float f = resources.getFloat(17105094);
