...
public class DragLayout extends View {
    ...
    public DragLayout(Context context, SplitScreenController splitScreenController) {
        ...
        this.mDisplayMargin = context.getResources().getDimensionPixelSize(C2219R.dimen.drop_layout_display_margin);
        ...
        if (this.mIsShowing) {
            ...
            for (int i = 0; i < targets.size(); i++) {
                ...
                if (ShellProtoLogCache.WM_SHELL_DRAG_AND_DROP_enabled) {
                    ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_DRAG_AND_DROP, -710770147, 0, (String) null, String.valueOf(target));
                }
    ...
    public void update(DragEvent dragEvent) {
        ...
        if (this.mCurrentTarget != targetAtLocation) {
            if (ShellProtoLogCache.WM_SHELL_DRAG_AND_DROP_enabled) {
                ...
                ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_DRAG_AND_DROP, 1481772149, 0, (String) null, valueOf);
            }
    ...
    public void hide(DragEvent dragEvent, final Runnable runnable) {
        ...
        if (runnable != null) {
            ...
            startVisibilityAnimation.addListener(new AnimatorListenerAdapter() {
