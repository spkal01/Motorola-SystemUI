...
public final class OneHandedSettingsUtil {
    ...
    public int getTransitionDuration(Context context) {
        return context.getResources().getInteger(C2219R.integer.config_one_handed_translate_animation_duration);
    }

    public float getTranslationFraction(Context context) {
        return context.getResources().getFraction(C2219R.fraction.config_one_handed_offset, 1, 1);
    }
