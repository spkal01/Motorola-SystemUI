...
public class OneHandedTutorialHandler implements OneHandedTransitionCallback, OneHandedState.OnStateChangedListener, OneHandedAnimationCallback {
    ...
    public void createViewAndAttachToWindow(Context context) {
        if (!isAttached()) {
            this.mTutorialView = LayoutInflater.from(context).inflate(C2219R.layout.one_handed_tutorial, (ViewGroup) null);
    ...
    private void updateThemeColor() {
        if (this.mTutorialView != null) {
            ...
            ((ImageView) this.mTutorialView.findViewById(C2219R.C2222id.one_handed_tutorial_image)).setImageTintList(ColorStateList.valueOf(color));
            ((TextView) this.mTutorialView.findViewById(C2219R.C2222id.one_handed_tutorial_title)).setTextColor(color);
            ((TextView) this.mTutorialView.findViewById(C2219R.C2222id.one_handed_tutorial_description)).setTextColor(color2);
        }
    }
