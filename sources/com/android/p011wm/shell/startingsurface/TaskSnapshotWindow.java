...
public class TaskSnapshotWindow {
    ...
    static TaskSnapshotWindow create(StartingWindowInfo startingWindowInfo, IBinder iBinder, TaskSnapshot taskSnapshot, ShellExecutor shellExecutor, Runnable runnable) {
        ...
        TaskSnapshotWindow taskSnapshotWindow = new TaskSnapshotWindow(surfaceControl, taskSnapshot, layoutParams3.getTitle(), taskDescription2, i2, i3, i4, rect, orientation, i5, taskSnapshot.hasImeSurface() ? 350 : 100, insetsState, runnable, shellExecutor);
        ...
        try {
            ...
            int addToDisplay = windowSession.addToDisplay(window, layoutParams4, 8, i6, insetsState2, inputChannel, insetsState2, insetsSourceControlArr2);
            Trace.traceEnd(32);
            if (addToDisplay < 0) {
                String str2 = TAG;
        ...
        try {
            ...
            windowSession.relayout(window, layoutParams4, -1, -1, 0, 0, -1, clientWindowFrames2, mergedConfiguration, surfaceControl, insetsState2, insetsSourceControlArr2, TMP_SURFACE_SIZE);
            Trace.traceEnd(32);
    ...
    public void lambda$remove$0() {
        ...
        if (uptimeMillis - j >= j2 || this.mActivityType == 2) {
            ...
            this.mSplashScreenExecutor.executeDelayed(new TaskSnapshotWindow$$ExternalSyntheticLambda0(this), (j + j2) - uptimeMillis);
        }
    }
    ...
    static class SystemBarBackgroundPainter {
        ...
        SystemBarBackgroundPainter(int i, int i2, int i3, ActivityManager.TaskDescription taskDescription, float f, InsetsState insetsState) {
            ...
            int color = systemUiContext.getColor(17171103);
            ...
            int calculateBarColor2 = DecorView.calculateBarColor(i, 134217728, color, taskDescription.getNavigationBarColor(), i3, 16, taskDescription.getEnsureNavigationBarContrastWhenTransparent() && systemUiContext.getResources().getBoolean(17891667));
