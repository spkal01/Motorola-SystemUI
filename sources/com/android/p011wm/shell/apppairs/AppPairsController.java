    ...
    public void unpair(int i, boolean z) {
        ...
        if (appPair != null) {
            if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
                long j = (long) i;
                ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -234284913, 1, (String) null, Long.valueOf(j), String.valueOf(appPair));
            }
            ...
            ShellProtoLogImpl.m93v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 950299522, 1, (String) null, Long.valueOf((long) i));
        }
    }
