...
import com.android.p011wm.shell.common.AlphaOptimizedButton;
...
public class BubbleExpandedView extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mManageButton = (AlphaOptimizedButton) LayoutInflater.from(getContext()).inflate(C2219R.layout.bubble_manage_button, this, false);
        updateDimensions();
        View findViewById = findViewById(C2219R.C2222id.pointer_view);
    ...
    public void initialize(BubbleController bubbleController, BubbleStackView bubbleStackView, boolean z) {
        ...
        if (this.mIsOverflow) {
            BubbleOverflowContainerView bubbleOverflowContainerView = (BubbleOverflowContainerView) LayoutInflater.from(getContext()).inflate(C2219R.layout.bubble_overflow_container, (ViewGroup) null);
        ...
        TaskView taskView = new TaskView(this.mContext, this.mController.getTaskOrganizer());
    ...
    public void updateDimensions() {
        ...
        this.mMinHeight = resources.getDimensionPixelSize(C2219R.dimen.bubble_expanded_default_height);
        this.mOverflowHeight = resources.getDimensionPixelSize(C2219R.dimen.bubble_overflow_height);
        updateFontSize();
        this.mPointerMargin = resources.getDimensionPixelSize(C2219R.dimen.bubble_pointer_margin);
        this.mPointerWidth = resources.getDimensionPixelSize(C2219R.dimen.bubble_pointer_width);
        this.mPointerHeight = resources.getDimensionPixelSize(C2219R.dimen.bubble_pointer_height);
        this.mPointerRadius = (float) getResources().getDimensionPixelSize(C2219R.dimen.bubble_pointer_radius);
        this.mPointerEffect = new CornerPathEffect(this.mPointerRadius);
        this.mPointerOverlap = (float) getResources().getDimensionPixelSize(C2219R.dimen.bubble_pointer_overlap);
        ...
        this.mManageButtonHeight = resources.getDimensionPixelSize(C2219R.dimen.bubble_manage_button_height);
        ...
        if (alphaOptimizedButton != null) {
            ...
            AlphaOptimizedButton alphaOptimizedButton2 = (AlphaOptimizedButton) LayoutInflater.from(getContext()).inflate(C2219R.layout.bubble_manage_button, this, false);
    ...
    public void onConfigChanged() {
        AlphaOptimizedButton alphaOptimizedButton = this.mManageButton;
        if (alphaOptimizedButton != null) {
            alphaOptimizedButton.setText(getResources().getString(C2219R.string.manage_bubbles_text));
        }
    }
    ...
    public void applyThemeAttrs() {
        ...
        if (this.mTaskView != null && ScreenDecorationsUtils.supportsRoundedCornersOnWindows(this.mContext.getResources())) {
    ...
    public void update(Bubble bubble) {
        ...
        if (z || (bubble != null && bubble.getKey().equals(this.mBubble.getKey()))) {
            this.mBubble = bubble;
            this.mManageButton.setContentDescription(getResources().getString(C2219R.string.bubbles_settings_button_description, new Object[]{bubble.getAppName()}));
        ...
        if (this.mExpandedViewContainerLocation != null) {
            ...
            if ((bubble != null && this.mTaskView != null) || this.mIsOverflow) {
                if (this.mIsOverflow) {
                    ...
                    f = bubble.getDesiredHeight(this.mContext);
                }
    ...
    public void setPointerPosition(float f, boolean z) {
        ...
        post(new BubbleExpandedView$$ExternalSyntheticLambda1(this, showBubblesVertically, f2 - expandedViewY, z));
    }
    ...
    public /* synthetic */ void lambda$setPointerPosition$1(boolean z, float f, boolean z2) {
        ...
        if (z) {
            ...
            if (z2) {
                ...
                f3 = ((float) (getWidth() - this.mPaddingRight)) - this.mPointerOverlap;
            }
        } else {
