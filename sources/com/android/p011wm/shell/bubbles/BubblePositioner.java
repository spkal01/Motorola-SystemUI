...
public class BubblePositioner {
    ...
    public void updateInternal(int i, Insets insets, Rect rect) {
        ...
        this.mBubbleBadgeSize = resources.getDimensionPixelSize(C2219R.dimen.bubble_badge_size);
        this.mSpacingBetweenBubbles = resources.getDimensionPixelSize(C2219R.dimen.bubble_spacing);
        this.mDefaultMaxBubbles = resources.getInteger(C2219R.integer.bubbles_max_rendered);
        this.mExpandedViewLargeScreenWidth = resources.getDimensionPixelSize(C2219R.dimen.bubble_expanded_view_tablet_width);
        this.mExpandedViewPadding = resources.getDimensionPixelSize(C2219R.dimen.bubble_expanded_view_padding);
        this.mPointerWidth = (float) resources.getDimensionPixelSize(C2219R.dimen.bubble_pointer_width);
        this.mPointerHeight = (float) resources.getDimensionPixelSize(C2219R.dimen.bubble_pointer_height);
    ...
    public int getBubbleSize() {
        ...
        L_0x000b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p011wm.shell.bubbles.BubblePositioner.getBubbleSize():int");
    }
    ...
    public PointF getDefaultStartPosition() {
        ...
        return new BubbleStackView.RelativeStackPosition(z, ((float) this.mContext.getResources().getDimensionPixelOffset(C2219R.dimen.bubble_stack_starting_offset_y)) / ((float) this.mPositionRect.height())).getAbsolutePositionInRegion(new RectF(this.mPositionRect));
    }
