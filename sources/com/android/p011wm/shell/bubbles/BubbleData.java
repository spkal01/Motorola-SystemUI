...
public class BubbleData {
    ...
    public BubbleData(Context context, BubbleLogger bubbleLogger, BubblePositioner bubblePositioner, Executor executor) {
        ...
        this.mMaxOverflowBubbles = context.getResources().getInteger(C2219R.integer.bubbles_max_overflow);
    }
    ...
    public com.android.p011wm.shell.bubbles.Bubble getOrCreateBubble(com.android.p011wm.shell.bubbles.BubbleEntry r5, com.android.p011wm.shell.bubbles.Bubble r6) {
        /*
            r4 = this;
        ...
        L_0x001d:
            ...
            com.android.wm.shell.bubbles.Bubble r6 = (com.android.p011wm.shell.bubbles.Bubble) r6
            goto L_0x003d
        L_0x002e:
        ...
        L_0x0042:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p011wm.shell.bubbles.BubbleData.getOrCreateBubble(com.android.wm.shell.bubbles.BubbleEntry, com.android.wm.shell.bubbles.Bubble):com.android.wm.shell.bubbles.Bubble");
    }
    ...
    public void removeBubblesWithInvalidShortcuts(String str, List<ShortcutInfo> list, int i) {
        ...
        BubbleData$$ExternalSyntheticLambda9 bubbleData$$ExternalSyntheticLambda9 = new BubbleData$$ExternalSyntheticLambda9(str, hashSet);
        BubbleData$$ExternalSyntheticLambda2 bubbleData$$ExternalSyntheticLambda2 = new BubbleData$$ExternalSyntheticLambda2(this, i);
    ...
    public void removeBubblesWithPackageName(String str, int i) {
        BubbleData$$ExternalSyntheticLambda8 bubbleData$$ExternalSyntheticLambda8 = new BubbleData$$ExternalSyntheticLambda8(str);
        BubbleData$$ExternalSyntheticLambda3 bubbleData$$ExternalSyntheticLambda3 = new BubbleData$$ExternalSyntheticLambda3(this, i);
    ...
    private void trim() {
        if (this.mBubbles.size() > this.mMaxBubbles) {
            ...
            ArrayList arrayList = new ArrayList();
            this.mBubbles.stream().sorted(Comparator.comparingLong(BubbleData$$ExternalSyntheticLambda10.INSTANCE)).filter(new BubbleData$$ExternalSyntheticLambda7(this)).forEachOrdered(new BubbleData$$ExternalSyntheticLambda4(arrayList, size));
            arrayList.forEach(new BubbleData$$ExternalSyntheticLambda1(this));
        }
    }
    ...
    private boolean repackAll() {
        ...
        this.mBubbles.stream().sorted(BUBBLES_BY_SORT_KEY_DESCENDING).forEachOrdered(new BubbleData$$ExternalSyntheticLambda5(arrayList));
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        for (Bubble dump2 : this.mOverflowBubbles) {
            dump2.dump(fileDescriptor, printWriter, strArr);
        }
