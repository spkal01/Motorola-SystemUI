...
public class BubbleIconFactory extends BaseIconFactory {
    private int mBadgeSize = this.mContext.getResources().getDimensionPixelSize(C2219R.dimen.bubble_badge_size);

    public BubbleIconFactory(Context context) {
        super(context, context.getResources().getConfiguration().densityDpi, context.getResources().getDimensionPixelSize(C2219R.dimen.bubble_size));
    }
    ...
    public BitmapInfo getBadgeBitmap(Drawable drawable, boolean z) {
        ...
        if (z) {
            int color = this.mContext.getResources().getColor(C2219R.C2220color.important_conversation, (Resources.Theme) null);
            ...
            int dimensionPixelSize = (int) ((float) this.mContext.getResources().getDimensionPixelSize(17105262));
