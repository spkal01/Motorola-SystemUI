...
import com.android.p011wm.shell.common.split.DividerHandleView;
...
public class DividerView extends FrameLayout implements View.OnTouchListener, ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    public DividerView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mHandleDelegate = new View.AccessibilityDelegate() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (DividerView.this.isHorizontalDivision()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_tl_full, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_top_full)));
                    if (snapAlgorithm.isFirstSplitTargetAvailable()) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_tl_70, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_top_70)));
                    }
                    if (snapAlgorithm.showMiddleSplitTargetForAccessibility()) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_tl_50, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_top_50)));
                    }
                    if (snapAlgorithm.isLastSplitTargetAvailable()) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_tl_30, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_top_30)));
                    }
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_rb_full, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_bottom_full)));
                    return;
                }
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_tl_full, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_left_full)));
                if (snapAlgorithm.isFirstSplitTargetAvailable()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_tl_70, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_left_70)));
                }
                if (snapAlgorithm.showMiddleSplitTargetForAccessibility()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_tl_50, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_left_50)));
                }
                if (snapAlgorithm.isLastSplitTargetAvailable()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_tl_30, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_left_30)));
                }
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2219R.C2222id.action_move_rb_full, DividerView.this.mContext.getString(C2219R.string.accessibility_action_divider_right_full)));
            }
            ...
            public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
                ...
                if (i == C2219R.C2222id.action_move_tl_full) {
                    dismissStartTarget = snapAlgorithm.getDismissEndTarget();
                } else if (i == C2219R.C2222id.action_move_tl_70) {
                    dismissStartTarget = snapAlgorithm.getLastSplitTarget();
                } else if (i == C2219R.C2222id.action_move_tl_50) {
                    dismissStartTarget = snapAlgorithm.getMiddleTarget();
                } else if (i == C2219R.C2222id.action_move_tl_30) {
                    dismissStartTarget = snapAlgorithm.getFirstSplitTarget();
                } else {
                    dismissStartTarget = i == C2219R.C2222id.action_move_rb_full ? snapAlgorithm.getDismissStartTarget() : null;
                }
        ...
        this.mUpdateEmbeddedMatrix = new DividerView$$ExternalSyntheticLambda1(this);
    ...
    public void onFinishInflate() {
        ...
        this.mHandle = (DividerHandleView) findViewById(C2219R.C2222id.docked_divider_handle);
        this.mBackground = findViewById(C2219R.C2222id.docked_divider_background);
        this.mMinimizedShadow = (MinimizedDockShadow) findViewById(C2219R.C2222id.minimized_dock_shadow);
        this.mHandle.setOnTouchListener(this);
        int dimensionPixelSize = getResources().getDimensionPixelSize(17105206);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(17105205);
        this.mDividerInsets = dimensionPixelSize2;
        this.mDividerSize = dimensionPixelSize - (dimensionPixelSize2 * 2);
        this.mTouchElevation = getResources().getDimensionPixelSize(C2219R.dimen.docked_stack_divider_lift_elevation);
        this.mLongPressEntraceAnimDuration = getResources().getInteger(C2219R.integer.long_press_dock_anim_duration);
    ...
    public void setHidden(boolean z) {
        if (this.mSurfaceHidden != z) {
            ...
            post(new DividerView$$ExternalSyntheticLambda2(this, z));
        }
    }
    ...
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L_0x00d3:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p011wm.shell.legacysplitscreen.DividerView.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }
    ...
    private ValueAnimator getFlingAnimator(int i, DividerSnapAlgorithm.SnapTarget snapTarget, final long j) {
        ...
        final DividerView$$ExternalSyntheticLambda3 dividerView$$ExternalSyntheticLambda3 = new DividerView$$ExternalSyntheticLambda3(this, snapTarget);
        ofInt.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                DividerView.this.getHandler().postDelayed(new DividerView$3$$ExternalSyntheticLambda0(dividerView$$ExternalSyntheticLambda3, Boolean.valueOf(this.mCancelled)), j);
            }
        });
    ...
    private boolean commitSnapFlags(com.android.internal.policy.DividerSnapAlgorithm.SnapTarget r6) {
        ...
        L_0x001e:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p011wm.shell.legacysplitscreen.DividerView.commitSnapFlags(com.android.internal.policy.DividerSnapAlgorithm$SnapTarget):boolean");
    }
