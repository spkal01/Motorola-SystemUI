...
public class KeyguardSliceView extends LinearLayout {
        ...
        for (int i3 = this.mHasHeader; i3 < size; i3++) {
            ...
            if (find != null) {
                ...
                try {
                    ...
                    Log.i("KeyguardSliceView", "failed loading drawable with mContext", e);
                    drawable = null;
                }
                if (drawable != null) {
    ...
    public static class Row extends LinearLayout {
        ...
        public void onMeasure(int i, int i2) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt instanceof KeyguardSliceTextView) {
                    ...
                    } else if (childCount <= 2 || !childAt.getTag().equals(Uri.parse("content://com.android.systemui.keyguard/date"))) {
                        ((KeyguardSliceTextView) childAt).setMaxWidth(size / childCount);
                    } else {
                        ((KeyguardSliceTextView) childAt).setMaxWidth(size / 2);
                    }
                }
            }
        ...
        public void setLockscreenMode(int i) {
            ...
            for (KeyguardSliceTextView lockScreenMode : this.mKeyguardSliceTextViewSet) {
                lockScreenMode.setLockScreenMode(this.mLockScreenModeRow);
            }
        }
    }
    ...
    static class KeyguardSliceTextView extends TextView {
        ...
        private void updateDrawableColors() {
            if (getTag() == null || !getTag().equals(Uri.parse("content://com.android.systemui.keyguard/weather"))) {
