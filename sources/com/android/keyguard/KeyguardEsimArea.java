...
class KeyguardEsimArea extends Button implements View.OnClickListener {
        ...
        this.mReceiver = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                ...
                if ("com.android.keyguard.disable_esim".equals(intent.getAction()) && (resultCode = getResultCode()) != 0) {
                    ...
                    AlertDialog create = new AlertDialog.Builder(KeyguardEsimArea.this.mContext).setMessage(R$string.error_disable_esim_msg).setTitle(R$string.error_disable_esim_title).setCancelable(false).setPositiveButton(R$string.f72ok, (DialogInterface.OnClickListener) null).create();
    ...
    public void onClick(View view) {
        ...
        this.mEuiccManager.switchToSubscription(-1, PendingIntent.getBroadcastAsUser(this.mContext, 0, intent, 167772160, UserHandle.SYSTEM));
    }
}
