...
public class KeyguardClockSwitchController extends ViewController<KeyguardClockSwitch> {
    ...
    private final ClockManager.ClockChangedListener mClockChangedListener = new KeyguardClockSwitchController$$ExternalSyntheticLambda1(this);
    private FrameLayout mClockFrame;
    private final ClockManager mClockManager;
    private AnimatableClockController mClockViewController;
    private final SysuiColorExtractor mColorExtractor;
    private final ColorExtractor.OnColorsChangedListener mColorsListener = new KeyguardClockSwitchController$$ExternalSyntheticLambda0(this);
