...
class GradientStrokeParser {
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.m6of("n", "v");
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.m6of("p", "k");
    private static JsonReader.Options NAMES = JsonReader.Options.m6of("nm", "g", "o", "t", "s", "e", "w", "lc", "lj", "ml", "hd", "d");
