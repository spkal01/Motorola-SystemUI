...
class FontCharacterParser {
    private static final JsonReader.Options DATA_NAMES = JsonReader.Options.m6of("shapes");
    private static final JsonReader.Options NAMES = JsonReader.Options.m6of("ch", "size", "w", "style", "fFamily", "data");
