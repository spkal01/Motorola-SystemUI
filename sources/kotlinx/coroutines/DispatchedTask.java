        ...
        try {
            ...
            if (delegate$kotlinx_coroutines_core != null) {
                ...
                if (exceptionalResult$kotlinx_coroutines_core == null && job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m849constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(cancellationException, continuation))));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.Companion;
                    continuation.resumeWith(Result.m849constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(exceptionalResult$kotlinx_coroutines_core, continuation))));
                } else {
                ...
                try {
                    ...
                    obj2 = Result.m849constructorimpl(unit);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.Companion;
                    obj2 = Result.m849constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException$kotlinx_coroutines_core((Throwable) null, Result.m851exceptionOrNullimpl(obj2));
                return;
            }
            ...
            try {
                ...
                taskContext.afterTask();
                obj = Result.m849constructorimpl(Unit.INSTANCE);
            } catch (Throwable th3) {
                Result.Companion companion7 = Result.Companion;
                obj = Result.m849constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException$kotlinx_coroutines_core(th2, Result.m851exceptionOrNullimpl(obj));
        }
    }
}
