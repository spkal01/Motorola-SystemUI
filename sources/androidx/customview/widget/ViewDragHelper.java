...
public class ViewDragHelper {
    ...
    public boolean isEdgeTouched(int r2, int r3) {
        /*
            ...
            int[] r1 = r1.mInitialEdgesTouched
        ...
        L_0x0012:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.customview.widget.ViewDragHelper.isEdgeTouched(int, int):boolean");
    }
