...
public class CompatPinnedList {
    ...
    /* JADX WARNING: Unknown top exception splitter block from list: {B:13:0x0065=Splitter:B:13:0x0065, B:20:0x007d=Splitter:B:20:0x007d} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized androidx.collection.ArraySet<androidx.slice.SliceSpec> getSpecs(android.net.Uri r7) {
        /*
            r6 = this;
            monitor-enter(r6)
            androidx.collection.ArraySet r0 = new androidx.collection.ArraySet     // Catch:{ all -> 0x0084 }
            r0.<init>()     // Catch:{ all -> 0x0084 }
            android.content.SharedPreferences r1 = r6.getPrefs()     // Catch:{ all -> 0x0084 }
            ...
            java.lang.String r3 = r7.toString()     // Catch:{ all -> 0x0084 }
            r2.append(r3)     // Catch:{ all -> 0x0084 }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x0084 }
            r3 = 0
            java.lang.String r2 = r1.getString(r2, r3)     // Catch:{ all -> 0x0084 }
            ...
            java.lang.String r7 = r1.getString(r7, r3)     // Catch:{ all -> 0x0084 }
            boolean r1 = android.text.TextUtils.isEmpty(r2)     // Catch:{ all -> 0x0084 }
            if (r1 != 0) goto L_0x007d
            boolean r1 = android.text.TextUtils.isEmpty(r7)     // Catch:{ all -> 0x0084 }
            if (r1 == 0) goto L_0x004c
            goto L_0x007d
        L_0x004c:
            java.lang.String r1 = ","
            r3 = -1
            java.lang.String[] r1 = r2.split(r1, r3)     // Catch:{ all -> 0x0084 }
            java.lang.String r2 = ","
            java.lang.String[] r7 = r7.split(r2, r3)     // Catch:{ all -> 0x0084 }
            int r2 = r1.length     // Catch:{ all -> 0x0084 }
            int r3 = r7.length     // Catch:{ all -> 0x0084 }
            if (r2 == r3) goto L_0x0064
            androidx.collection.ArraySet r7 = new androidx.collection.ArraySet     // Catch:{ all -> 0x0084 }
        ...
        L_0x0064:
            r2 = 0
        L_0x0065:
            int r3 = r1.length     // Catch:{ all -> 0x0084 }
            if (r2 >= r3) goto L_0x007b
            androidx.slice.SliceSpec r3 = new androidx.slice.SliceSpec     // Catch:{ all -> 0x0084 }
            r4 = r1[r2]     // Catch:{ all -> 0x0084 }
            r5 = r7[r2]     // Catch:{ all -> 0x0084 }
            int r5 = java.lang.Integer.parseInt(r5)     // Catch:{ all -> 0x0084 }
            r3.<init>(r4, r5)     // Catch:{ all -> 0x0084 }
