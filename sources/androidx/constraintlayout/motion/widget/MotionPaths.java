...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths3.f15x;
        float f9 = motionPaths3.f16y;
        float f10 = (motionPaths4.f15x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths4.f16y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f15x = (float) ((int) ((f8 + (f10 * f)) - f13));
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f16y = (float) ((int) ((f9 + (f11 * f)) - f15));
        ...
        this.f15x = (float) ((int) (((motionPaths5.f15x + (f16 * f10)) + (f17 * f11)) - f13));
        this.f16y = (float) ((int) (((motionPaths5.f16y + (f10 * f18)) + (f11 * f)) - f15));
    ...
    public void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths3.f15x;
        float f9 = motionPaths3.f16y;
        float f10 = motionPaths4.f15x + (f4 / 2.0f);
        float f11 = motionPaths4.f16y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f15x = (float) ((int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f)));
        float f13 = (f6 - f7) * f3;
        this.f16y = (float) ((int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f)));
        this.width = (float) ((int) (f5 + f12));
        this.height = (float) ((int) (f7 + f13));
        this.mMode = 3;
        KeyPosition keyPosition3 = keyPosition;
        if (!Float.isNaN(keyPosition3.mPercentX)) {
            this.f15x = (float) ((int) (keyPosition3.mPercentX * ((float) ((int) (((float) i) - this.width)))));
        }
        if (!Float.isNaN(keyPosition3.mPercentY)) {
            this.f16y = (float) ((int) (keyPosition3.mPercentY * ((float) ((int) (((float) i2) - this.height)))));
        }
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition3.mTransitionEasing);
        this.mPathMotionArc = keyPosition3.mPathMotionArc;
    }
    ...
    public void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths3.f15x;
        float f7 = motionPaths3.width;
        float f8 = motionPaths3.f16y;
        float f9 = motionPaths3.height;
        float f10 = (motionPaths4.f15x + (motionPaths4.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths4.f16y + (motionPaths4.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = f4 * f2;
        float f14 = f13 / 2.0f;
        this.f15x = (float) ((int) ((f6 + f12) - f14));
        float f15 = f * f11;
        float f16 = f5 * f3;
        float f17 = f16 / 2.0f;
        this.f16y = (float) ((int) ((f8 + f15) - f17));
        ...
        this.mMode = 1;
        MotionPaths motionPaths5 = motionPaths;
        float f21 = (float) ((int) ((motionPaths5.f15x + f12) - f14));
        this.f15x = f21;
        float f22 = (float) ((int) ((motionPaths5.f16y + f15) - f17));
        this.f16y = f22;
        this.f15x = f21 + f19;
        this.f16y = f22 + f20;
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition3.mTransitionEasing);
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        ...
        zArr[1] = zArr[1] | diff(this.f15x, motionPaths.f15x) | z;
        zArr[2] = z | diff(this.f16y, motionPaths.f16y) | zArr[2];
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f15x, this.f16y, this.width, this.height, this.mPathRotate};
        int i = 0;
        for (int i2 = 0; i2 < iArr.length; i2++) {
            if (iArr[i2] < 6) {
