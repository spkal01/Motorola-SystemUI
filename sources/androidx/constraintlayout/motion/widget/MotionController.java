...
public class MotionController {
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f15x;
    }

    /* access modifiers changed from: package-private */
    public float getFinalY() {
        return this.mEndMotionPath.f16y;
    }
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i21 = 0; i21 < size; i21++) {
                ...
                dArr6[i21][0] = (double) motionPathsArr[i21].f15x;
                dArr6[i21][1] = (double) motionPathsArr[i21].f16y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f15x + " y: " + this.mStartMotionPath.f16y + " end: x: " + this.mEndMotionPath.f15x + " y: " + this.mEndMotionPath.f16y;
    }
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        MotionPaths motionPaths = this.mEndMotionPath;
        float f5 = motionPaths.f15x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f6 = f5 - motionPaths2.f15x;
        float f7 = motionPaths.f16y - motionPaths2.f16y;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f7 = motionPaths3.f15x;
            MotionPaths motionPaths4 = this.mStartMotionPath;
            float f8 = f7 - motionPaths4.f15x;
            float f9 = motionPaths3.f16y - motionPaths4.f16y;
