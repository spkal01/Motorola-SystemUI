...
public class ArrayLinkedVariables {
    ...
    public final void put(SolverVariable solverVariable, float f) {
        ...
        if (i == -1) {
            ...
            this.mArrayIndices[0] = solverVariable.f17id;
        ...
        this.mArrayIndices[i7] = solverVariable.f17id;
    ...
    public final float remove(SolverVariable solverVariable, boolean z) {
        ...
        while (i != -1 && i2 < this.currentSize) {
            if (this.mArrayIndices[i] == solverVariable.f17id) {
                if (i == this.mHead) {
                    this.mHead = this.mArrayNextIndices[i];
                } else {
    ...
    public SolverVariable getPivotCandidate(boolean[] zArr, SolverVariable solverVariable) {
        ...
        while (i != -1 && i2 < this.currentSize) {
            ...
            if (f2 < 0.0f) {
                ...
                if ((zArr == null || !zArr[solverVariable3.f17id]) && solverVariable3 != solverVariable && (((type = solverVariable3.mType) == SolverVariable.Type.SLACK || type == SolverVariable.Type.ERROR) && f2 < f)) {
                    f = f2;
